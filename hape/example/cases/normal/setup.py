...
class CaseConfig:
    def __init__(self):
        ...
        self.queries = [
            ...
            "select in0_summary_.id, in0_summary_.title, in0_summary_.subject from in0 inner join in0_summary_ on in0.id=in0_summary_.id where MATCHINDEX('default', '阿里巴巴集团')&&kvpair=databaseName:database;formatType:string"]
