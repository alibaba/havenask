...
public:
    ...
    /* virtual for mock */
    virtual void get(const std::string &url, QueryResult &queryResult);
    ...
    virtual void delete_(const std::string &spec,
                      const std::string &uri,
                      QueryResult &queryResult);

    virtual void put(const std::string &spec,
                      const std::string &uri,
...
private:
    ...
    anet::HTTPPacket* createPayloadRequest(anet::HTTPPacket::HTTPMethod method, const std::string &spec, 
                                           const std::string &uri,
