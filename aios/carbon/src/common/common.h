...
#define DEFAULT_AMONITOR_AGENT_PORT 10086
...
#define KEY_IGNORE_PROCESS_STATUS "IGNORE_PROCESS_STATUS"
#define KEY_SLAVE_DEAD_TIMEOUT "SLAVE_DEAD_TIMEOUT"
...
#define SYSCONFIG_SERIALIZE_FILE_NAME "_sysconfig_"
...
#define WHEN_FS_FILE_EXIST(serializer) \
    do { \
        ...
        if (!exist) { \
            CARBON_LOG(INFO, "serializer dir not exist, not need recover:" #serializer); \
            break; \
        } \
