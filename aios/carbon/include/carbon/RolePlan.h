...
public:
    VersionedPlan() {
        ...
        recoverResourceNotMatchNode = true;
        preload = false;
    };
    ...
    void Jsonize(autil::legacy::Jsonizable::JsonWrapper &json) {
        ...
        if (json.GetMode() == autil::legacy::Jsonizable::TO_JSON) {
            ...
            if (!recoverResourceNotMatchNode) {
                JSON_FIELD(recoverResourceNotMatchNode);
            }
        } else {
            JSON_FIELD(recoverResourceNotMatchNode);
            JSON_FIELD(restartAfterResourceChange);
    ...
    void updateBoardcastField(const VersionedPlan &rhs) {
        ...
        recoverResourceNotMatchNode = rhs.recoverResourceNotMatchNode;
    }
...
public:
    ...
    bool recoverResourceNotMatchNode;
    bool preload;
};
