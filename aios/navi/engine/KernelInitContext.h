...
public:
    ...
    AsyncPipePtr createAsyncPipe(ActivateStrategy activateStrategy = AS_REQUIRED);
    ResourcePtr buildR(const std::string &name, KernelConfigContext ctx, ResourceMap &inputResourceMap) const;
public:
