...
public:
    void setNaviSymbolTable(const NaviSymbolTable *naviSymbolTable);
...
private:
    ...
    void loop();
    std::string getBtStringNavi() const;
private:
    ...
    Thread m_worker;
    const NaviSymbolTable *_naviSymbolTable = nullptr;
    bool _neddConsoleLog = false;
  private:
