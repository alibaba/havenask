...
const char *CommonUtil::getErrorString(ErrorCode ec) {
    ...
    case EC_PART_ID_NOT_EXIST:
        return "EC_PART_ID_NOT_EXIST";
    case EC_PART_COUNT_MISMATCH:
        return "EC_PART_COUNT_MISMATCH";
    case EC_LACK_REGISTRY:
        return "EC_LACK_REGISTRY";
    case EC_ILLEGAL_RESOURCE_STAGE:
        return "EC_ILLEGAL_RESOURCE_STAGE";
    case EC_RESOURCE_CONFIG:
        return "EC_RESOURCE_CONFIG";
    case EC_BIND_RESOURCE:
        return "EC_BIND_RESOURCE";
    case EC_BIND_NAMED_DATA:
        return "EC_BIND_NAMED_DATA";
    case EC_LACK_RESOURCE_SNAPSHOT:
        return "EC_LACK_RESOURCE_SNAPSHOT";
    case EC_LACK_RESOURCE_BIZ:
        return "EC_LACK_RESOURCE_BIZ";
    case EC_LACK_RESOURCE_BIZ_PART:
        return "EC_LACK_RESOURCE_BIZ_PART";
    case EC_LACK_RESOURCE_GRAPH:
        return "EC_LACK_RESOURCE_GRAPH";
    case EC_LACK_RESOURCE_SUB_GRAPH:
        return "EC_LACK_RESOURCE_SUB_GRAPH";
    case EC_LACK_RESOURCE_SCOPE:
        return "EC_LACK_RESOURCE_SCOPE";
    case EC_LACK_RESOURCE_KERNEL:
        return "EC_LACK_RESOURCE_KERNEL";
    case EC_LACK_RESOURCE_EXTERNAL:
        return "EC_LACK_RESOURCE_EXTERNAL";
    case EC_LACK_REPLACE_RESOURCE:
        return "EC_LACK_REPLACE_RESOURCE";
    case EC_REWRITE_GRAPH:
        return "EC_REWRITE_GRAPH";
    case EC_ADD_NAMED_DATA:
...
const char *CommonUtil::getActivateStrategy(ActivateStrategy as) {
    switch (as) {
    case AS_REQUIRED:
        return "AS_REQUIRED";
    case AS_OPTIONAL:
