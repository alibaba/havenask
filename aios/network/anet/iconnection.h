...
namespace anet
{
    ...
    public:
        ...
        */
       virtual bool postPacket(Packet *packet, IPacketHandler *packetHandler,
    		   void *args, bool blockWhenQueueFull) = 0;
        ...
        */
       virtual Packet *sendPacket(Packet *packet,
                                  bool blockWhenQueueFull) = 0;
