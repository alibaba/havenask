...
public:
    ...
    size_t getUseListCount() { return atomic_read(&_useCount); }

private:
    inline void addUseCountByOne() { atomic_add(1, &_useCount); }

    inline void subUseCountByOne() { atomic_sub(1, &_useCount); }
