...
void ControllerParam::logParam() {
    ...
    paramMap["MIN_INTERNAL_TARGET_WEIGHT_FLOAT"] =
        Any(MIN_INTERNAL_TARGET_WEIGHT_FLOAT);
    paramMap["MAX_WEIGHT_UPDATE_STEP_FLOAT"] =
        Any(MAX_WEIGHT_UPDATE_STEP_FLOAT);
    paramMap["MIN_WEIGHT_UPDATE_STEP_FLOAT"] =
        Any(MIN_WEIGHT_UPDATE_STEP_FLOAT);
    ...
    paramMap["LOAD_BALANCE_FILTER_INIT_LIMIT"] =
        Any(LOAD_BALANCE_FILTER_INIT_LIMIT);
    paramMap["NET_LATENCY_FILTER_INIT_LIMIT"] =
        Any(NET_LATENCY_FILTER_INIT_LIMIT);
    paramMap["ERROR_RATIO_WEIGHT_DEC_STEP"] = Any(ERROR_RATIO_WEIGHT_DEC_STEP);
    paramMap["DEGRADE_RATIO_WEIGHT_DEC_STEP"] =
        Any(DEGRADE_RATIO_WEIGHT_DEC_STEP);
    paramMap["LATENCY_WEIGHT_DEC_STEP"] = Any(LATENCY_WEIGHT_DEC_STEP);
    paramMap["DEFAULT_PROBE_PERCENT"] = Any(DEFAULT_PROBE_PERCENT);
    paramMap["DEFAULT_LATENCY_UPPER_LIMIT_PERCENT"] =
        Any(DEFAULT_LATENCY_UPPER_LIMIT_PERCENT);
    paramMap["DEFAULT_LATENCY_UPPER_LIMIT_MS"] =
        Any(DEFAULT_LATENCY_UPPER_LIMIT_MS);
    ...
    paramMap["HEARTBEAT_UNHEALTH_INTERVAL"] =
        Any(HEARTBEAT_UNHEALTH_INTERVAL / FACTOR_US_TO_MS);
    AUTIL_LOG(INFO, "ControllerParam:\n%s",
              ToJsonString(paramMap, true).c_str());
}
