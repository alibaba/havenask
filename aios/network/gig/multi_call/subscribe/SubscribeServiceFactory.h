 ...
 */
#ifndef ISEARCH_MULTI_CALL_SUBSCRIBESERVICEFACTORY_H
#define ISEARCH_MULTI_CALL_SUBSCRIBESERVICEFACTORY_H
...
#endif // ISEARCH_MULTI_CALL_SUBSCRIBESERVICEFACTORY_H
