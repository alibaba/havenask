...
protected:
    ...
    std::unique_ptr<Mutex> m_appendMutex;
    Layout* m_layout;
...
private:
    ...
    static std::unique_ptr<Mutex> s_appenderMutex;
};
...
private:
    ...
    static std::unique_ptr<Mutex> s_appenderMapMutex;
    time_t m_delayTime;
    ...
    std::unique_ptr<Mutex> m_pendingBufferListMutex;
