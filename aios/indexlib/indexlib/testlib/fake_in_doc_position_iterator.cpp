...
FakeInDocPositionIterator(const std::vector<pos_t> &occArray,
    ...
    : _occArray(occArray),_fieldBitArray(fieldBitArray),_sectionIdArray(sectionIdArray)
{ 
    _offset = -1;
}
...
common::ErrorCode FakeInDocPositionIterator::SeekPositionWithErrorCode(pos_t pos, pos_t& nextpos)
{
