...
public:
    ...
    void GetPartitionMetrics(test::PartitionMetrics& partitionMetrics) {}

public:
    void setIndexPartitionReader(const partition::IndexPartitionReaderPtr &reader)
    {
        _reader = reader;
    }
