...
IE_LOG_SETUP(common, DateTermMaker);
...
void DateTermMaker::MakeDateTerms(uint64_t left, uint64_t right,
...
void DateTermMaker::MakeDateTerms(uint64_t year, uint64_t left, uint64_t right,
                                std::vector<uint64_t>& ret)
{
    std::vector<DateTerm> ans;
    for (uint64_t i = left; i <= right; i ++)
...
void DateTermMaker::MakeDateTerms(uint64_t year, uint64_t month,
...
void DateTermMaker::MakeDateTerms(uint64_t year, uint64_t month, uint64_t day,
                                 uint64_t left, uint64_t right,
                                 std::vector<uint64_t>& ret)
{
    std::vector<DateTerm> ans;
...
void DateTermMaker::MakeMiddleTerms(uint64_t year, uint64_t month,
                                    uint64_t left, uint64_t right,
                                    std::vector<uint64_t>& ret)
{
    std::vector<DateTerm> ans;
...
void DateTermMaker::MakeMiddleTerms(uint64_t year, uint64_t month, uint64_t day,
                                    uint64_t left, uint64_t right,
                                    std::vector<uint64_t>& ret)
{
    std::vector<DateTerm> ans;
