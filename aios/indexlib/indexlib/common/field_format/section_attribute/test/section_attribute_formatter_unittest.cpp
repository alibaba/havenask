...
void SectionAttributeFormatterTest::SetUp()
{
}

void SectionAttributeFormatterTest::TearDown()
{
}
...
SectionAttributeFormatterPtr SectionAttributeFormatterTest::CreateFormatter(
        bool hasFieldId, bool hasWeight)
{
    SectionAttributeConfigPtr sectionAttrConfig(
            new SectionAttributeConfig("", hasWeight, hasFieldId));
    return SectionAttributeFormatterPtr(
            new SectionAttributeFormatter(sectionAttrConfig));
}


void SectionAttributeFormatterTest::CheckBuffer(
        uint8_t *buffer, uint32_t sectionCount,
...
void SectionAttributeFormatterTest::TestUnpackBuffer()
{
    ...
    {
        ASSERT_EQ((uint32_t)sectionCount, SectionAttributeFormatter::UnpackBuffer(
                        (const uint8_t*)&sectionCount, true, true,
                        lenBuf, fidBuf, weightBuf));
    ...
    {
        ASSERT_EQ((uint32_t)sectionCount, SectionAttributeFormatter::UnpackBuffer(
                        (const uint8_t*)&sectionCount, false, true,
                        lenBuf, fidBuf, weightBuf));
    ...
    {
        ASSERT_EQ((uint32_t)sectionCount, SectionAttributeFormatter::UnpackBuffer(
                        (const uint8_t*)&sectionCount, true, false,
                        lenBuf, fidBuf, weightBuf));
    ...
    {
        ASSERT_EQ((uint32_t)sectionCount, SectionAttributeFormatter::UnpackBuffer(
                        (const uint8_t*)&sectionCount, false, false,
                        lenBuf, fidBuf, weightBuf));
