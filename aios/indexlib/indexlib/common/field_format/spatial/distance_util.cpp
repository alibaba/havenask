...
IE_LOG_SETUP(common, DistanceUtil);
...
RectanglePtr DistanceUtil::CalculateBoundingBoxFromPoint(
...
RectanglePtr DistanceUtil::CalculateBoundingBoxFromPointDeg(
...
double DistanceUtil::CalcBoxByDistFromPt_deltaLonDEG(
        double lat, double lon, double distDEG) 
{
...
double DistanceUtil::DistHaversineRAD(
