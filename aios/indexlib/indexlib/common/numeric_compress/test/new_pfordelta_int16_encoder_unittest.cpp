...
class NewPForDeltaInt16EncoderTest : public INDEXLIB_TESTBASE
{
public:
    DECLARE_CLASS_NAME(NewPForDeltaInt16EncoderTest);
    ...
    void TestCaseForDecode()
    {
        ...
        for (size_t i = 0; i < DECODE_TIMES; ++i)
        {
            ...
            {
                buffer[j] = (int16_t)(j * 7 + i * 3);
            }
            NewPForDeltaInt16Encoder encoder;
...
INDEXLIB_UNIT_TEST_CASE(NewPForDeltaInt16EncoderTest, TestCaseForDecode);
