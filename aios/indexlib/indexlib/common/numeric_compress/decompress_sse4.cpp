...
#include "indexlib/common/numeric_compress/decompress_sse4.h"
...
//c1
const __m128i SSE4_c1_and_msk1_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0x08, 
						     0x00, 0x00, 0x00, 0x04, 
						     0x00, 0x00, 0x00, 0x02, 
						     0x00, 0x00, 0x00, 0x01);
...
const __m128i SSE4_c1_and_msk2_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0x80, 
						     0x00, 0x00, 0x00, 0x40, 
						     0x00, 0x00, 0x00, 0x20, 
						     0x00, 0x00, 0x00, 0x10);
...
{
     __m128i SSE4_c1_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment,
						   0xFF, 0xFF, 0xFF, segment,
						   0xFF, 0xFF, 0xFF, segment,
						   0xFF, 0xFF, 0xFF, segment);
     ...
     SSE4_c1_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment,
					   0xFF, 0xFF, 0xFF, segment,
					   0xFF, 0xFF, 0xFF, segment,
					   0xFF, 0xFF, 0xFF, segment);
...
//c2
const __m128i SSE4_c2_and_msk_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0xC0, 
						    0x00, 0x00, 0x00, 0x30, 
						    0x00, 0x00, 0x00, 0x0C, 
						    0x00, 0x00, 0x00, 0x03);
...
{
     __m128i SSE4_c2_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment,
						   0xFF, 0xFF, 0xFF, segment,
						   0xFF, 0xFF, 0xFF, segment,
						   0xFF, 0xFF, 0xFF, segment);
...
//c3
const __m128i SSE4_c3_and_msk1_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0x0E, 
						     0x00, 0x00, 0x01, 0xC0, 
						     0x00, 0x00, 0x00, 0x38, 
						     0x00, 0x00, 0x00, 0x07);

const __m128i SSE4_c3_and_msk2_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0xE0, 
						     0x00, 0x00, 0x00, 0x1C, 
						     0x00, 0x00, 0x03, 0x80, 
						     0x00, 0x00, 0x00, 0x70);							                   
...
{
     __m128i SSE4_c3_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment+1,
						   0xFF, 0xFF, segment+1, segment,
						   0xFF, 0xFF, 0xFF, segment,
						   0xFF, 0xFF, 0xFF, segment);
     ...
     SSE4_c3_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment+2, 
					   0xFF, 0xFF, 0xFF, segment+2, 
					   0xFF, 0xFF, segment+2, segment+1, 
					   0xFF, 0xFF, 0xFF, segment+1);
...
//c4
const __m128i SSE4_c4_and_msk_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0xF0, 
						    0x00, 0x00, 0x00, 0x0F, 
						    0x00, 0x00, 0x00, 0xF0, 
						    0x00, 0x00, 0x00, 0x0F);
...
{
     __m128i SSE4_c4_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment+1,
						   0xFF, 0xFF, 0xFF, segment+1,
						   0xFF, 0xFF, 0xFF, segment,
						   0xFF, 0xFF, 0xFF, segment);
...
//c5
const __m128i SSE4_c5_and_msk1_m128i = _mm_set_epi8 (0x00, 0x00, 0x0F, 0x80, 
						     0x00, 0x00, 0x00, 0x7C, 
						     0x00, 0x00, 0x03, 0xE0, 
						     0x00, 0x00, 0x00, 0x1F);

const __m128i SSE4_c5_and_msk2_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0xF8, 
						     0x00, 0x00, 0x07, 0xC0, 
						     0x00, 0x00, 0x00, 0x3E, 
						     0x00, 0x00, 0x01, 0xF0);							                   
...
inline void decompress_sse4_c5_m2(__m128i c5_load_vec_m128i, unsigned int*& presult)
{
     ...
     __m128i SSE4_c5_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+2, segment+1,
						   0xFF, 0xFF, 0xFF, segment+1,
						   0xFF, 0xFF, segment+1, segment,
						   0xFF, 0xFF, 0xFF, segment);
     ...
     SSE4_c5_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment+4, 
					   0xFF, 0xFF, segment+4, segment+3, 
					   0xFF, 0xFF, 0xFF, segment+3, 
					   0xFF, 0xFF, segment+3, segment+2);
...
//c6
const __m128i SSE4_c6_and_msk1_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0xFC, 
						     0x00, 0x00, 0x03, 0xF0, 
						     0x00, 0x00, 0x0F, 0xC0, 
						     0x00, 0x00, 0x00, 0x3F);
...
{
     // decompress first 4 values
     __m128i SSE4_c6_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment+2,
						   0xFF, 0xFF, segment+2, segment+1,
						   0xFF, 0xFF, segment+1, segment,
						   0xFF, 0xFF, 0xFF, segment);
...
//c7
const __m128i SSE4_c7_and_msk1_m128i = _mm_set_epi8 (0x00, 0x00, 0x0F, 0xE0, 
						     0x00, 0x00, 0x1F, 0xC0, 
						     0x00, 0x00, 0x3F, 0x80, 
						     0x00, 0x00, 0x00, 0x7F);

const __m128i SSE4_c7_and_msk2_m128i = _mm_set_epi8 (0x00, 0x00, 0x00, 0xFE, 
						     0x00, 0x00, 0x01, 0xFC, 
						     0x00, 0x00, 0x03, 0xF8, 
						     0x00, 0x00, 0x07, 0xF0);							                   
...
{
     // decompress first 4 values
     __m128i SSE4_c7_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+3, segment+2,
						   0xFF, 0xFF, segment+2, segment+1,
						   0xFF, 0xFF, segment+1, segment,
						   0xFF, 0xFF, 0xFF, segment);
     ...
     // decompress second 4 values
     SSE4_c7_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment+6, 
					   0xFF, 0xFF, segment+6, segment+5, 
					   0xFF, 0xFF, segment+5, segment+4, 
					   0xFF, 0xFF, segment+4, segment+3);
...
{
     __m128i SSE4_c8_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, segment+3,
						   0xFF, 0xFF, 0xFF, segment+2,
						   0xFF, 0xFF, 0xFF, segment+1,
						   0xFF, 0xFF, 0xFF, segment);
...
//c9
const __m128i SSE4_c9_and_msk1_m128i = _mm_set_epi8 (0x00, 0x00, 0x0F, 0xF8, 
						     0x00, 0x00, 0x07, 0xFC, 
						     0x00, 0x00, 0x03, 0xFE, 
						     0x00, 0x00, 0x01, 0xFF);

const __m128i SSE4_c9_and_msk2_m128i = _mm_set_epi8 (0x00, 0x00, 0xFF, 0x80, 
						     0x00, 0x00, 0x7F, 0xC0, 
						     0x00, 0x00, 0x3F, 0xE0, 
						     0x00, 0x00, 0x1F, 0xF0);							                   
...
{
     // decompress first 4 values
     __m128i SSE4_c9_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+4, segment+3,
						   0xFF, 0xFF, segment+3, segment+2,
						   0xFF, 0xFF, segment+2, segment+1,
						   0xFF, 0xFF, segment+1, segment);
     ...
     // decompress second 4 values
     SSE4_c9_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+8, segment+7, 
					   0xFF, 0xFF, segment+7, segment+6, 
					   0xFF, 0xFF, segment+6, segment+5, 
					   0xFF, 0xFF, segment+5, segment+4);
...
//c10
const __m128i SSE4_c10_and_msk1_m128i = _mm_set_epi8 (0x00, 0x00, 0xFF, 0xC0, 
		 				      0x00, 0x00, 0x3F, 0xF0, 
		 				      0x00, 0x00, 0x0F, 0xFC, 
						      0x00, 0x00, 0x03, 0xFF);
...
{
     // decompress first 4 values
     __m128i SSE4_c10_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+4, segment+3,
						    0xFF, 0xFF, segment+3, segment+2,
						    0xFF, 0xFF, segment+2, segment+1,
						    0xFF, 0xFF, segment+1, segment);
...
//c11
const __m128i SSE4_c11_and_msk1_m128i = _mm_set_epi8 (0x00, 0x00, 0x0F, 0xFE, 
						      0x00, 0x01, 0xFF, 0xC0, 
						      0x00, 0x00, 0x3F, 0xF8, 
						      0x00, 0x00, 0x07, 0xFF);

const __m128i SSE4_c11_and_msk2_m128i = _mm_set_epi8 (0x00, 0x00, 0xFF, 0xE0, 
						      0x00, 0x00, 0x1F, 0xFC, 
						      0x00, 0x03, 0xFF, 0x80, 
						      0x00, 0x00, 0x7F, 0xF0);							                   
...
{
     // decompress first 4 values
     __m128i SSE4_c11_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+5, segment+4,
						    0xFF, segment+4, segment+3, segment+2,
						    0xFF, 0xFF, segment+2, segment+1,
						    0xFF, 0xFF, segment+1, segment);
     ...
     presult = presult + 4;
     // decompress second 4 values
     SSE4_c11_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+10, segment+9, 
					    0xFF, 0xFF, segment+9, segment+8, 
					    0xFF, segment+8, segment+7, segment+6, 
					    0xFF, 0xFF, segment+6, segment+5);
...
//c12
const __m128i SSE4_c12_and_msk1_m128i = _mm_set_epi8(0x00, 0x00, 0xFF, 0xF0, 
						     0x00, 0x00, 0x0F, 0xFF, 
						     0x00, 0x00, 0xFF, 0xF0, 
						     0x00, 0x00, 0x0F, 0xFF);						                   
...
inline void decompress_sse4_c12_m2(__m128i c12_load_vec_m128i, unsigned int*& presult)
{
     ...
     __m128i SSE4_c12_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+5, segment+4,
						    0xFF, 0xFF, segment+4, segment+3,
						    0xFF, 0xFF, segment+2, segment+1,
						    0xFF, 0xFF, segment+1, segment);
...
//c13
const __m128i SSE4_c13_and_msk1_m128i = _mm_set_epi8 (0x00, 0x0F, 0xFF, 0x80, 
						      0x00, 0x00, 0x7F, 0xFC, 
						      0x00, 0x03, 0xFF, 0xE0, 
						      0x00, 0x00, 0x1F, 0xFF);
							                         
const __m128i SSE4_c13_and_msk2_m128i = _mm_set_epi8 (0x00, 0x00, 0xFF, 0xF8, 
						      0x00, 0x07, 0xFF, 0xC0, 
						      0x00, 0x00, 0x3F, 0xFE, 
						      0x00, 0x01, 0xFF, 0xF0);							                   
...
{
	// decompress first 4 values
	__m128i SSE4_c13_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+6, segment+5, segment+4,
						       0xFF, 0xFF, segment+4, segment+3,
						       0xFF, segment+3, segment+2, segment+1,
						       0xFF, 0xFF, segment+1, segment);
	...
	// decompress second 4 values
	SSE4_c13_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+12, segment+11, 
					       0xFF, segment+11, segment+10, segment+9, 
					       0xFF, 0xFF, segment+9, segment+8, 
					       0xFF, segment+8, segment+7, segment+6);
...
//c14
const __m128i SSE4_c14_and_msk1_m128i = _mm_set_epi8(0x00, 0x00, 0xFF, 0xFC, 
						     0x00, 0x03, 0xFF, 0xF0, 
						     0x00, 0x0F, 0xFF, 0xC0, 
						     0x00, 0x00, 0x3F, 0xFF);							                         
...
{
     // decompress first 4 values
     __m128i SSE4_c14_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+6, segment+5,
						    0xFF, segment+5, segment+4, segment+3,
						    0xFF, segment+3, segment+2, segment+1,
						    0xFF, 0xFF, segment+1, segment);
...
{
     // decompress first 4 values
     __m128i SSE4_c15_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+7, segment+6, segment+5,
						    0xFF, segment+5, segment+4, segment+3,
						    0xFF, segment+3, segment+2, segment+1,
						    0xFF, 0xFF, segment+1, segment);
     ...
     // decompress second 4 values
     SSE4_c15_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+14, segment+13, 
					    0xFF, segment+13, segment+12, segment+11, 
					    0xFF, segment+11, segment+10, segment+9, 
					    0xFF, segment+9, segment+8, segment+7);
...
{
     __m128i SSE4_c16_shfl_msk_m128i = _mm_set_epi8(0xFF, 0xFF, segment+7, segment+6,
						    0xFF, 0xFF, segment+5, segment+4,
						    0xFF, 0xFF, segment+3, segment+2,
						    0xFF, 0xFF, segment+1, segment);
...
//c17
const __m128i SSE4_c17_and_msk1_m128i = _mm_set_epi8 (0x00, 0x0F, 0xFF, 0xF8, 
						      0x00, 0x07, 0xFF, 0xFC, 
						      0x00, 0x03, 0xFF, 0xFE, 
						      0x00, 0x01, 0xFF, 0xFF);

const __m128i SSE4_c17_and_msk2_m128i = _mm_set_epi8 (0x00, 0xFF, 0xFF, 0x80, 
						      0x00, 0x7F, 0xFF, 0xC0, 
						      0x00, 0x3F, 0xFF, 0xE0, 
						      0x00, 0x1F, 0xFF, 0xF0);							                   
...
{
	// decompress first 4 values
     __m128i SSE4_c17_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+8, segment+7, segment+6,
						    0xFF, segment+6, segment+5, segment+4,
						    0xFF, segment+4, segment+3, segment+2,
						    0xFF, segment+2, segment+1, segment);
...
//c18
const __m128i SSE4_c18_and_msk1_m128i = _mm_set_epi8 (0x00, 0xFF, 0xFF, 0xC0, 
						      0x00, 0x3F, 0xFF, 0xF0, 
						      0x00, 0x0F, 0xFF, 0xFC, 
						      0x00, 0x03, 0xFF, 0xFF);
...
{
     // decompress first 4 values
     __m128i SSE4_c18_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+8, segment+7, segment+6,
						    0xFF, segment+6, segment+5, segment+4,
						    0xFF, segment+4, segment+3, segment+2,
						    0xFF, segment+2, segment+1, segment);
...
//c19
const __m128i SSE4_c19_and_msk1_m128i = _mm_set_epi8 (0x00, 0x0F, 0xFF, 0xFE, 
						      0x01, 0xFF, 0xFF, 0xC0, 
						      0x00, 0x3F, 0xFF, 0xF8, 
						      0x00, 0x07, 0xFF, 0xFF);
							                         
const __m128i SSE4_c19_and_msk2_m128i = _mm_set_epi8 (0x00, 0xFF, 0xFF, 0xE0, 
						      0x00, 0x1F, 0xFF, 0xFC, 
						      0x03, 0xFF, 0xFF, 0x80, 
						      0x00, 0x7F, 0xFF, 0xF0);							                   
...
{
     // decompress first 4 values
     __m128i SSE4_c19_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+9, segment+8, segment+7,
						    segment+7, segment+6, segment+5, segment+4,
						    0xFF, segment+4, segment+3, segment+2,
						    0xFF, segment+2, segment+1, segment);
...
inline void decompress_sse4_c19_m2_s2(__m128i c19_load_vec_m128i, unsigned int*& presult)
{
     // decompress first 4 values
     __m128i SSE4_c19_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+9, segment+8, segment+7,
						    0xFF, segment+7, segment+6, segment+5,
						    segment+5, segment+4, segment+3, segment+2,
						    0xFF, segment+2, segment+1, segment);
...
//c20
const __m128i SSE4_c20_and_msk1_m128i = _mm_set_epi8 (0x00, 0xFF, 0xFF, 0xF0, 
						      0x00, 0x0F, 0xFF, 0xFF, 
						      0x00, 0xFF, 0xFF, 0xF0, 
						      0x00, 0x0F, 0xFF, 0xFF);
...
{
     // decompress first 4 values
     __m128i SSE4_c20_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+9, segment+8, segment+7,
						    0xFF, segment+7, segment+6, segment+5,
						    0xFF, segment+4, segment+3, segment+2,
						    0xFF, segment+2, segment+1, segment);
...
//c21
const __m128i SSE4_c21_and_msk1_m128i = _mm_set_epi8 (0x0F, 0xFF, 0xFF, 0x80, 
						      0x00, 0x7F, 0xFF, 0xFC, 
						      0x03, 0xFF, 0xFF, 0xE0, 
						      0x00, 0x1F, 0xFF, 0xFF);
							                         
const __m128i SSE4_c21_and_msk2_m128i = _mm_set_epi8 (0x00, 0xFF, 0xFF, 0xF8, 
						      0x07, 0xFF, 0xFF, 0xC0, 
						      0x00, 0x3F, 0xFF, 0xFE, 
						      0x01, 0xFF, 0xFF, 0xF0);							                   
...
{
     // decompress first 4 values
     __m128i SSE4_c21_shfl_msk_m128i = _mm_set_epi8(segment+10, segment+9, segment+8, segment+7,
						    0xFF, segment+7, segment+6, segment+5,
						    segment+5, segment+4, segment+3, segment+2,
						    0xFF, segment+2, segment+1, segment);
...
{
     // decompress first 4 values
     __m128i SSE4_c21_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+10, segment+9, segment+8,
						    segment+8, segment+7, segment+6, segment+5,
						    0xFF, segment+5, segment+4, segment+3,
						    segment+3, segment+2, segment+1, segment);
...
//c22
const __m128i SSE4_c22_and_msk1_m128i = _mm_set_epi8 (0x00, 0xFF, 0xFF, 0xFC, 
						      0x03, 0xFF, 0xFF, 0xF0, 
						      0x0F, 0xFF, 0xFF, 0xC0, 
						      0x00, 0x3F, 0xFF, 0xFF);							                   
...
{
     // decompress first 4 values
     __m128i SSE4_c22_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+10, segment+9, segment+8,
						    segment+8, segment+7, segment+6, segment+5,
						    segment+5, segment+4, segment+3, segment+2,
						    0xFF, segment+2, segment+1, segment);
...
//c23
const __m128i SSE4_c23_and_msk1_m128i = _mm_set_epi8 (0x0F, 0xFF, 0xFF, 0xE0, 
						      0x1F, 0xFF, 0xFF, 0xC0, 
						      0x3F, 0xFF, 0xFF, 0x80, 
						      0x00, 0x7F, 0xFF, 0xFF);

const __m128i SSE4_c23_and_msk2_m128i = _mm_set_epi8 (0xFF, 0xFF, 0xFF, 0xFE, 
						      0x01, 0xFF, 0xFF, 0xFC, 
						      0x03, 0xFF, 0xFF, 0xF8, 
						      0x07, 0xFF, 0xFF, 0xF0);							                   
...
{
	// decompress first 4 values
     __m128i SSE4_c23_shfl_msk_m128i = _mm_set_epi8(segment+11, segment+10, segment+9, segment+8,
						    segment+8, segment+7, segment+6, segment+5,
						    segment+5, segment+4, segment+3, segment+2,
						    0xFF, segment+2, segment+1, segment);
...
{
     // decompress first 4 values
     __m128i SSE4_c23_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+11, segment+10, segment+9,
						    segment+9, segment+8, segment+7, segment+6,
...
{
     // decompress first 4 values
     __m128i SSE4_c24_shfl_msk_m128i = _mm_set_epi8(0xFF, segment+11, segment+10, segment+9,
						    0xFF, segment+8, segment+7, segment+6,
						    0xFF, segment+5, segment+4, segment+3,
						    0xFF, segment+2, segment+1, segment);
...
//c25
const __m128i SSE4_c25_and_msk1_m128i = _mm_set_epi8 (0x0F, 0xFF, 0xFF, 0xF8, 
						      0x07, 0xFF, 0xFF, 0xFC, 
						      0x03, 0xFF, 0xFF, 0xFE, 
						      0x01, 0xFF, 0xFF, 0xFF);

const __m128i SSE4_c25_and_msk2_m128i = _mm_set_epi8 (0xFF, 0xFF, 0xFF, 0x80, 
						      0x7F, 0xFF, 0xFF, 0xC0, 
						      0x3F, 0xFF, 0xFF, 0xE0, 
						      0x1F, 0xFF, 0xFF, 0xF0);							                   
...
{
     // decompress first 4 values
     __m128i SSE4_c25_shfl_msk_m128i = _mm_set_epi8(segment+12, segment+11, segment+10, segment+9,
						    segment+9, segment+8, segment+7, segment+6,
						    segment+6, segment+5, segment+4, segment+3,
						    segment+3, segment+2, segment+1, segment);
...
//c26
const __m128i SSE4_c26_and_msk1_m128i = _mm_set_epi8 (0xFF, 0xFF, 0xFF, 0xC0, 
						      0x3F, 0xFF, 0xFF, 0xF0, 
						      0x0F, 0xFF, 0xFF, 0xFC, 
						      0x03, 0xFF, 0xFF, 0xFF);						                   
...
{
     // decompress first 4 values
     __m128i SSE4_c26_shfl_msk_m128i = _mm_set_epi8(segment+12, segment+11, segment+10, segment+9,
						    segment+9, segment+8, segment+7, segment+6,
						    segment+6, segment+5, segment+4, segment+3,
						    segment+3, segment+2, segment+1, segment);
...
//c27
const __m128i SSE4_c27_and_msk1_m128i = _mm_set_epi8 (0x0F, 0xFF, 0xFF, 0xFE, 
						      0x07, 0xFF, 0xFF, 0xFF, 
						      0x3F, 0xFF, 0xFF, 0xF8, 
						      0x07, 0xFF, 0xFF, 0xFF);

const __m128i SSE4_c27_and_msk2_m128i = _mm_set_epi8 (0xFF, 0xFF, 0xFF, 0xE0, 
						      0x1F, 0xFF, 0xFF, 0xFC, 
						      0x07, 0xFF, 0xFF, 0xFF, 
						      0x7F, 0xFF, 0xFF, 0xF0);							                   
...
inline void decompress_sse4_c27_m2_s1(__m128i c27_load_vec_m128i, unsigned int*& presult)
{
     ...
     __m128i SSE4_c27_shfl_msk_m128i = _mm_set_epi8(segment+13, segment+12, segment+11, segment+10,
						    segment+9, segment+8, segment+7, segment+6,
						    segment+6, segment+5, segment+4, segment+3,
						    segment+3, segment+2, segment+1, segment);
...
inline void decompress_sse4_c27_m2_s2(__m128i c27_load_vec_m128i, unsigned int*& presult)
{
     ...
     __m128i SSE4_c27_shfl_msk_m128i = _mm_set_epi8(segment+13, segment+12, segment+11, segment+10,
						    segment+10, segment+9, segment+8, segment+7,
						    segment+7, segment+6, segment+5, segment+4,
						    segment+3, segment+2, segment+1, segment);
...
//c28
const __m128i SSE4_c28_and_msk1_m128i = _mm_set_epi8(0xFF, 0xFF, 0xFF, 0xF0, 
						     0x0F, 0xFF, 0xFF, 0xFF, 
						     0xFF, 0xFF, 0xFF, 0xF0, 
						     0x0F, 0xFF, 0xFF, 0xFF);							                         
...
{
     __m128i SSE4_c28_shfl_msk_m128i = _mm_set_epi8(segment+13, segment+12, segment+11, segment+10,
						    segment+10, segment+9, segment+8, segment+7,
						    segment+6, segment+5, segment+4, segment+3,
						    segment+3, segment+2, segment+1, segment);
...
//c29
const __m128i SSE4_c29_and_msk1_m128i = _mm_set_epi8 (0xFF, 0xFF, 0xFF, 0xF8, 
						      0x7F, 0xFF, 0xFF, 0xFC, 
						      0x3F, 0xFF, 0xFF, 0xFF, 
						      0x1F, 0xFF, 0xFF, 0xFF);

const __m128i SSE4_c29_and_msk2_m128i = _mm_set_epi8 (0xFF, 0xFF, 0xFF, 0xF8, 
						      0x7F, 0xFF, 0xFF, 0xFC, 
						      0x3F, 0xFF, 0xFF, 0xFE, 
						      0x1F, 0xFF, 0xFF, 0xFF);							                   
...
inline void decompress_sse4_c29_m2_s1(__m128i c29_load_vec_m128i, unsigned int*& presult)
{
     ...
     __m128i SSE4_c29_shfl_msk_m128i = _mm_set_epi8(segment+14, segment+13, segment+12, segment+11,
						    segment+10, segment+9, segment+8, segment+7,
						    segment+7, segment+6, segment+5, segment+4,
						    segment+3, segment+2, segment+1, segment);
...
//c30
const __m128i SSE4_c30_and_msk1_m128i = _mm_set_epi8 (0xFF, 0xFF, 0xFF, 0xFC, 
						      0x3F, 0xFF, 0xFF, 0xFF, 
						      0x3F, 0xFF, 0xFF, 0xFF, 
						      0x3F, 0xFF, 0xFF, 0xFF);						                   
...
inline void decompress_sse4_c30_m2(__m128i c30_load_vec_m128i, unsigned int* presult)
{
     ...
     __m128i SSE4_c30_shfl_msk_m128i = _mm_set_epi8(segment+14, segment+13, segment+12, segment+11,
						    segment+10, segment+9, segment+8, segment+7,
						    segment+7, segment+6, segment+5, segment+4,
						    segment+3, segment+2, segment+1, segment);
