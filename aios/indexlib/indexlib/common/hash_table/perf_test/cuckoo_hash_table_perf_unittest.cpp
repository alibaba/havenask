#include <algorithm>
#include "indexlib/common/hash_table/perf_test/cuckoo_hash_table_perf_unittest.h"
...
IE_LOG_SETUP(common, CuckooHashTablePerfTest);
...
CuckooHashTablePerfTest::CuckooHashTablePerfTest()
{
    mData = new char[Size + 48];
    mData += 48;
    cerr << "mDataAddr:" << (uint64_t)mData << endl;
}
...
void CuckooHashTablePerfTest::CaseSetUp()
{
    srand(11);
}

void CuckooHashTablePerfTest::CaseTearDown()
{
}
void CuckooHashTablePerfTest::TestOccupancy()
{
    HashTable hashTable;
    InitRandomKeys();
...
void CuckooHashTablePerfTest::TestInsertAndFind()
{
//    InitRandomKeys();
...
void CuckooHashTablePerfTest::InitRandomKeysFromFile()
{
...
void CuckooHashTablePerfTest::InitRandomKeys()
{
...
void CuckooHashTablePerfTest::InitSequentialKeys()
{
...
void CuckooHashTablePerfTest::FindSequential(const HashTable& hashTable)
{
...
void CuckooHashTablePerfTest::FindRandom(const HashTable& hashTable)
{
    uint64_t maxKeyCount = hashTable.Size();
...
void CuckooHashTablePerfTest::FindRandomRW(const HashTable& hashTable)
{
    uint64_t maxKeyCount = hashTable.Size();
...
void CuckooHashTablePerfTest::FindMix(const HashTable& hashTable)
{
    uint64_t maxKeyCount = hashTable.Size();
...
void CuckooHashTablePerfTest::InsertSequential(HashTable& hashTable)
{
...
void CuckooHashTablePerfTest::InsertRandom(HashTable& hashTable)
{
