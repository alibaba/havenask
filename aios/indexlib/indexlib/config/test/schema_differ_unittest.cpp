...
void SchemaDifferTest::TestSimpleProcess()
{
    string errorMsg;
    {
        ...
        IndexPartitionSchemaMaker::MakeSchema(oldSchema, "field1:long;field2:uint32",
                "pk:PRIMARYKEY64:field1", "field1;field2", "");
        IndexPartitionSchemaPtr newSchema(new IndexPartitionSchema);
        IndexPartitionSchemaMaker::MakeSchema(newSchema, "field1:long;field2:uint32;"
                "field3:string;field4:uint32", "pk:PRIMARYKEY64:field1",
                "field1;field2;field3;field4", "");
        vector<AttributeConfigPtr> alterAttributes;
        vector<IndexConfigPtr> alterIndexes;
        ASSERT_FALSE(SchemaDiffer::CalculateAlterFields(oldSchema, newSchema,
                        alterAttributes, alterIndexes));

        newSchema->SetSchemaVersionId(1);
        ASSERT_TRUE(SchemaDiffer::CalculateAlterFields(oldSchema, newSchema,
                        alterAttributes, alterIndexes));
...
void SchemaDifferTest::TestRemoveFieldFail()
{
        ...
        field, index, attribute, summary);
    {
        ...
        IndexPartitionSchemaPtr newSchema = SchemaMaker::MakeSchema(
            field, index, attribute, summary);
        newSchema->SetSchemaVersionId(1);
...
void SchemaDifferTest::TestRemoveField()
{
    string errorMsg;
    {
        ...
        IndexPartitionSchemaMaker::MakeSchema(oldSchema, "field1:long;field2:uint32",
                "pk:PRIMARYKEY64:field1", "field1;field2", "");
        IndexPartitionSchemaPtr newSchema(new IndexPartitionSchema);
        IndexPartitionSchemaMaker::MakeSchema(newSchema, "field1:long;"
                "field3:string;field4:uint32", "pk:PRIMARYKEY64:field1",
        ...
        newSchema->SetSchemaVersionId(1);
        ASSERT_TRUE(SchemaDiffer::CheckAlterFields(oldSchema, newSchema, errorMsg));
        ASSERT_TRUE(SchemaDiffer::CalculateAlterFields(
                        oldSchema, newSchema, alterAttributes, alterIndexes, errorMsg));
        ASSERT_EQ(2u, alterAttributes.size());
        ASSERT_EQ(0u, alterIndexes.size());
        vector<AttributeConfigPtr> deleteAttributes;
        vector<IndexConfigPtr> deleteIndexes;
        ASSERT_TRUE(SchemaDiffer::CalculateDeleteFields(
                        oldSchema, newSchema, deleteAttributes, deleteIndexes,
                        errorMsg));
    ...
    }
    {
        ...
        IndexPartitionSchemaPtr newSchema(new IndexPartitionSchema);
        IndexPartitionSchemaMaker::MakeSchema(newSchema, "field1:long;"
                "field2:uint32;field4:uint32", "pk:PRIMARYKEY64:field1",
...
void SchemaDifferTest::TestCustomizedIndex()
{
    ...
    IndexPartitionSchemaMaker::MakeSchema(oldSchema, "field1:long;field2:uint32",
            "pk:PRIMARYKEY64:field1;", "", "");
    IndexPartitionSchemaPtr newSchema = SchemaMaker::MakeSchema(
            "field1:long;field2:uint32;demo_field:raw",
...
void SchemaDifferTest::TestPackAttribute()
{
    ...
    IndexPartitionSchemaPtr oldSchema = SchemaMaker::MakeSchema(
            ...
            "pk:PRIMARYKEY64:field1;", "pack1:field1,field2", "");

    {
        // new attribute in current pack attribute
        IndexPartitionSchemaPtr newSchema = SchemaMaker::MakeSchema(
                "field1:long;field2:uint32;field3:uint64;field4:uint16",
                "pk:PRIMARYKEY64:field1", "pack1:field1,field2,field3", "");
        newSchema->SetSchemaVersionId(1);
...

    {
        ...
        IndexPartitionSchemaPtr newSchema = SchemaMaker::MakeSchema(
                "field1:long;field2:uint32;field3:uint64;field4:uint16",
                "pk:PRIMARYKEY64:field1", "pack1:field1,field2;pack2:field3,field4", "");
        newSchema->SetSchemaVersionId(1);
...
void SchemaDifferTest::TestModifySchemaOperation()
{
    ...
    ModifySchemaMaker::AddModifyOperations(newSchema1,
            "", "field3:uint64;field4:uint32", "", "field3;field4");

    IndexPartitionSchemaPtr newSchema2(oldSchema->Clone());
    ModifySchemaMaker::AddModifyOperations(newSchema2,
            "", "field3:uint64;field4:uint32", "", "field3;field4");
    ModifySchemaMaker::AddModifyOperations(newSchema2,
...
void SchemaDifferTest::TestUpdateFieldInModifySchema()
{
    ...
    IndexPartitionSchemaPtr newSchema(oldSchema->Clone());
    ModifySchemaMaker::AddModifyOperations(newSchema,
            "attributes=field2;indexs=numberIndex", "",
            "numberIndex:number:field1", "field2");
    ...
    ASSERT_TRUE(SchemaDiffer::CalculateAlterFields(
                    oldSchema, newSchema, attrConfigs, indexConfigs));
...
{
    {
        ...
        IndexPartitionSchemaPtr oldSchema(new IndexPartitionSchema);
        IndexPartitionSchemaMaker::MakeSchema(oldSchema, "field0:long;field2:uint32",
                                              "pk:PRIMARYKEY64:field0", "field0;field2", "");
        IndexPartitionSchemaPtr subSchema(new IndexPartitionSchema);
        ...
        IndexPartitionSchemaPtr newSchema(oldSchema->Clone());
        ModifySchemaMaker::AddModifyOperations(
            newSchema,
            "", "field3:uint64;field4:uint16", "", "field3;field4");
        ModifySchemaMaker::AddModifyOperations(
            newSchema->GetSubIndexPartitionSchema(),
            "", "field3:uint64;field4:uint16", "", "field3;field4");
        string errorMsg;
        ASSERT_FALSE(SchemaDiffer::CheckAlterFields(oldSchema, newSchema, errorMsg));
