...
public:
    ...
    { return mAttrConfigs.size(); }

    AttributeSchema::Iterator Begin() const { return mAttrConfigs.begin(); }
    AttributeSchema::Iterator End() const { return mAttrConfigs.end(); }
    AttributeConfigIteratorPtr CreateIterator(ConfigIteratorType type) const;
    PackAttributeConfigIteratorPtr CreatePackAttrIterator(ConfigIteratorType type) const;
...
/////////////////////////////////////////////////////////////////////
inline const AttributeConfigPtr& AttributeSchemaImpl::GetAttributeConfig(
        attrid_t attrId) const 
{
...
inline const AttributeConfigPtr& AttributeSchemaImpl::GetAttributeConfigByFieldId(
...
inline const PackAttributeConfigPtr&
AttributeSchemaImpl::GetPackAttributeConfig(const std::string& packAttrName) const
{
...
inline const PackAttributeConfigPtr&
AttributeSchemaImpl::GetPackAttributeConfig(packattrid_t packId) const
{
...
inline packattrid_t
AttributeSchemaImpl::GetPackIdByAttributeId(attrid_t attrId) const
{
