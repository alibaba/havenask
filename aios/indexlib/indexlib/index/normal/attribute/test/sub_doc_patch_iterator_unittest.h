#ifndef __INDEXLIB_SUBDOCPATCHITERATORTEST_H
#define __INDEXLIB_SUBDOCPATCHITERATORTEST_H
...
private:
    void CheckIter(SubDocPatchIterator& iter, 
                   docid_t expectDocid, fieldid_t expectFieldId,
                   int32_t expectPatchValue, bool isSub);
private:
    std::string mRootDir;
...
#endif //__INDEXLIB_SUBDOCPATCHITERATORTEST_H
