...
private:
    bool CheckResult(TrieIndexReader::Iterator* iter,
                     const std::string& expectStr);
    bool CheckPrefixSearch(const TrieIndexReader& reader,
                           const std::string& key, const std::string& expectStr,
                           int32_t maxMatches = -1);
    bool CheckInfixSearch(const TrieIndexReader& reader,
                          const std::string& key, const std::string& expectStr,
                          int32_t maxMatches = -1);
