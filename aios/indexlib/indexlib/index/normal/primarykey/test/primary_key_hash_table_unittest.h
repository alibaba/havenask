...
private:
    void InnerTestInsertAndLookUp(const std::string& kvStr,
                                  const std::string& queryStr);

    template <typename Key>
    void InnerTestInsertAndLookUpTyped(
        const std::string& kvStr, const std::string& queryStr); 
...
template <typename Key>
void PrimaryKeyHashTableTest::InnerTestInsertAndLookUpTyped(
    const std::string& kvStr, const std::string& queryStr)
{
