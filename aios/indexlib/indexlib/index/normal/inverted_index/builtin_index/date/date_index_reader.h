...
DECLARE_REFERENCE_CLASS(common, DateQueryParser);
DECLARE_REFERENCE_CLASS(index, DateIndexSegmentReader);
DECLARE_REFERENCE_CLASS(index, BuildingDateIndexReader);
DECLARE_REFERENCE_CLASS(index, DocValueFilter);
DECLARE_REFERENCE_CLASS(index, AttributeReader);

IE_NAMESPACE_BEGIN(index);

class DateIndexReader : public index::NormalIndexReader
{
public:
    DateIndexReader();
    ~DateIndexReader();
...
private:
    ...
    common::DateQueryParserPtr mDateQueryParser;
