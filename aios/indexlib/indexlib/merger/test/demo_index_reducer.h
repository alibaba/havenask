...
{
public:
    DemoParallelReduceMeta(uint32_t parallelCount)
        : index::ParallelReduceMeta(parallelCount)
    {}
public:
...
public:
    ...
    std::vector<index::ReduceTask> CreateReduceTasks(
        ...
        bool isEntireDataSet, index_base::MergeTaskResourceManagerPtr& resMgr) override;
