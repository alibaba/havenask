...
public:
    std::map<docid_t, std::string>::const_iterator Begin() const
    { return mDataMap.cbegin(); }
    std::map<docid_t, std::string>::const_iterator End() const
    { return mDataMap.cend(); }
    void SetMergeTaskResources(index_base::MergeTaskResourceVector& taskResources)
    {
