...
void MergeTaskItemTest::TestSimpleProcess()
{
    ...
    }
    {
        ...
        INDEXLIB_TEST_EQUAL(item1.mParallelMergeItem.mResourceIds.size(),
                            item2.mParallelMergeItem.mResourceIds.size());
        for (size_t i = 0; i < item1.mParallelMergeItem.mResourceIds.size(); i++)
        {
            ASSERT_EQ(item1.mParallelMergeItem.mResourceIds[i],
                      item2.mParallelMergeItem.mResourceIds[i]);
        }
    }
}
