...
private:
    ...
    void DoTestMerge(bool isFullMerge, bool isMultiPart,
                     const std::string& mergeStrategy,
                     const std::string& mergeStrategyParam,
                     bool isMergeTwice = false);
...
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestMultiPartFullMergeWithAllSegmentsMergeToOneSegment);
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestMultiPartFullMergeWithMultiSegmentsMergeToOneSegment);
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestMultiPartFullMergeWithSingleSegmentMergeToOneSegment);
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestSinglePartFullMergeWithAllSegmentsMergeToOneSegment);
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestSinglePartFullMergeWithMultiSegmentsMergeToOneSegment);
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestSinglePartFullMergeWithSingleSegmentMergeToOneSegment);
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestIncOptimizeMergeWithAllSegmentsMergeToOneSegment);
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestIncOptimizeMergeWithMultiSegmentsMergeToOneSegment);
INDEXLIB_UNIT_TEST_CASE_WITH_PARAM(MultiPartitionMergerInteTest, TestIncOptimizeMergeWithSingleSegmentMergeToOneSegment);
