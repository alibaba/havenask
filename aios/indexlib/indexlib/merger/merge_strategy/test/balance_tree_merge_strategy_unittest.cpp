...
public:
    ...
    void TestCaseForSetParameter()
    {
        ...
        INDEXLIB_TEST_EQUAL(ms4.GetParameter(), goodParam + ";conflict-delete-percent=100;max-valid-doc-count=" + autil::StringUtil::toString(uint32_t(-1)));
...
private:
    ...
    MergeTask CreateMergeTask(const SegmentMergeInfos& segMergeInfos,
                              bool optmize = false,
