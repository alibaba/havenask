...
void TimeSeriesMergeStrategyTest::TestSimpleProcess()
{
    string mergeParam = "max-doc-count=100;sort-field=time;|time=[0-20],output-interval=100;|"
     ...
     mergeParam
         = "max-doc-count=100;sort-field=time;|time=[10-30],output-interval=100;time=[50-100],"
          "output-interval=200;|max-merged-segment-doc-count=50";
     InnerTestTimeSeriesMergeTask(
             "20 10 1 1 time=10,40;20 10 1 1 time=30,70;20 10 1 1 time=30,120", mergeParam, "0,1", false);

     mergeParam
         = "max-doc-count=100;sort-field=time;|time=[0-30],output-interval=70;time=[50-80],"
          "output-interval=200;|max-merged-segment-doc-count=50";
     
     InnerTestTimeSeriesMergeTask(
             "20 10 1 1 time=60,90;20 10 1 1 time=30,70;20 10 1 1 time=30,50;20 10 1 1 time=80,120",
             mergeParam, "0,3;1,2", false);

     mergeParam
         = "max-doc-count=100;sort-field=time;|time=[ - ],output-interval=20;time=[50-80],"
          "output-interval=200;|max-merged-segment-doc-count=50";
     
     InnerTestTimeSeriesMergeTask(
             "20 10 1 1 time=30,50;20 10 1 1 time=50,150;20 10 1 1 time=150,160;20 10 1 1 time=160,170",
             mergeParam, "2,3", false);
...
void TimeSeriesMergeStrategyTest::TestInputOutputLimit()
{
    string mergeParam = "max-doc-count=10;sort-field=time;max-segment-size=2097152;|"
                        ...
                        "output-interval=200;|max-merged-segment-doc-count=50";
    InnerTestTimeSeriesMergeTask(
        "20 10 1 1 time=10,15;5 10 1 1 time=13,17", mergeParam, "", false);
    InnerTestTimeSeriesMergeTask(
        "20 10 1 1 time=10,15;5 1 1 2 time=13,17", mergeParam, "0,1", false);
    InnerTestTimeSeriesMergeTask(
        "12 10 1 1 time=10,15;5 1 1 3 time=12,18;1 1 1 2 time=13,20", mergeParam, "", false);

    mergeParam = "max-doc-count=80;sort-field=time;max-segment-size=2097152;|"
                        "time=[0-30],output-interval=10;time=[50-100],"
                        "output-interval=200;|max-merged-segment-doc-count=20";
    InnerTestTimeSeriesMergeTask(
            "60 10 1 1 time=10,15;5 1 1 1 time=12,14;20 1 1 1 time=10,20", mergeParam, "0,2", false);
}
...
void TimeSeriesMergeStrategyTest::TestRangeLimit()
{
    string mergeParam = "max-doc-count=30;sort-field=time;max-segment-size=2097152;|"
                        ...
                        "output-interval=200;|max-merged-segment-doc-count=50";
    InnerTestTimeSeriesMergeTask(
        "20 10 1 1 time=10,15;12 10 1 1 time=13,17;12 10 1 1 time=12,17", mergeParam, "0,1,2", false);
    ...
    InnerTestTimeSeriesMergeTask(
        "20 10 1 1 time=10,15;12 10 1 1 time=200,210;12 10 1 1 time=50,70", mergeParam, "", false);
...
void TimeSeriesMergeStrategyTest::TestMergeWithTag() 
{
    ...
    InnerTestTimeSeriesMergeTask(
        "12 10 1 1 time=10,15 lifecycle=warm;11 10 1 1 time=20,25 lifecycle=warm", mergeParam, "0,1", false);
    InnerTestTimeSeriesMergeTask(
            "12 10 1 1 time=10,15 lifecycle=hot;11 10 1 1 time=20,25 lifecycle=hot", mergeParam, "", false);
}


MergeTask TimeSeriesMergeStrategyTest::CreateMergeTask(
    const SegmentMergeInfos& segMergeInfos, const string& mergeStrategyParams, bool optmize)
{
...
void TimeSeriesMergeStrategyTest::CheckMergeTask(
        const string& expectResults, const MergeTask& task)
{
...
void TimeSeriesMergeStrategyTest::InnerTestTimeSeriesMergeTask(
        const string& originalSegs, const string& mergeParams, 
...
void TimeSeriesMergeStrategyTest::MakeSegmentMergeInfos(
        const string& str, SegmentMergeInfos& segMergeInfos)
{
    StringTokenizer st;
    ...
    for (StringTokenizer::Iterator it = st.begin(); it != st.end(); ++it, ++segId)
    {
        ...
        stSeg.tokenize(segInfoStr, " ", StringTokenizer::TOKEN_TRIM | 
