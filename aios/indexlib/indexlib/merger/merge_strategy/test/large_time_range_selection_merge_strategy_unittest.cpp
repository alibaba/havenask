...
void LargeTimeRangeSelectionMergeStrategyTest::TestSimpleProcess()
{
    ...
    InnerTestLargeTimeRangeSelectionMergeTask(
            "20 10 1 1 time=10,15;20 10 1 1 time=13,17", mergeParam, "", false);
    InnerTestLargeTimeRangeSelectionMergeTask(
            "20 10 1 1 time=10,15;20 10 1 1 time=13,200", mergeParam, "1", false);
}


MergeTask LargeTimeRangeSelectionMergeStrategyTest::CreateMergeTask(
...
void LargeTimeRangeSelectionMergeStrategyTest::CheckMergeTask(
...
void LargeTimeRangeSelectionMergeStrategyTest::InnerTestLargeTimeRangeSelectionMergeTask(
...
void LargeTimeRangeSelectionMergeStrategyTest::MakeSegmentMergeInfos(
