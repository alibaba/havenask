...
#define CREATE_PROCESSOR(fieldType)                                                               \
    ...
    {                                                                                             \
        ...
        {                                                                                         \
            ...
            {                                                                                     \
                INDEXLIB_FATAL_ERROR(                                                             \
                        BadParameter, "Invalid parameter for merge strategy [%s] condition [%s]", \
...
MergeTask LargeTimeRangeSelectionMergeStrategy::CreateMergeTaskForOptimize(
...
MergeTask LargeTimeRangeSelectionMergeStrategy::CreateMergeTask(
        const index_base::SegmentMergeInfos& segMergeInfos, 
        const index_base::LevelInfo& levelInfo)
{
    MergeTask task;
