#ifndef __INDEXLIB_SEGMENT_ITERATOR_HELPER_H
#define __INDEXLIB_SEGMENT_ITERATOR_HELPER_H
            ...
            std::vector<index_base::InMemorySegmentPtr>& inMemSegments)
    {
        ...
        for (size_t i = 0; i < segmentInfoVec.size(); i++)
        {
            ...
            index_base::InMemorySegmentPtr inMemSegment(
                new index_base::InMemorySegment(
...
#endif //__INDEXLIB_SEGMENT_ITERATOR_HELPER_H
