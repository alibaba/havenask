...
private:
    ...
    void CheckOperationCreator(
            const config::IndexPartitionSchemaPtr& schema, 
            OperationCreatorPtr operationCreator,
            const std::string& typeStr);

    void CheckSingleOperationCreator(
            const config::IndexPartitionSchemaPtr& schema, 
            OperationCreatorPtr operationCreator,
            const std::string& typeStr);

    void CheckSubDocOperationCreator(
            const config::IndexPartitionSchemaPtr& schema, 
            OperationCreatorPtr operationCreator,
            const std::string& mainTypeStr,
            const std::string& subTypeStr);

    void CheckOperationType(OperationBase* oper, const std::string& typeStr);

    void CheckSingleOperationType(OperationBase* oper, 
                                  const std::string& typeStr);

    void CheckSubDocOperationType(OperationBase* oper, 
                                  const std::string& mainTypeStr, 
                                  const std::string& subTypeStr);
