...
void InMemoryIndexCleanerTest::TestCleanWithSegmentNotInVersion()
{
    ...
    string rtSegPath = string("segment_") + StringUtil::toString(
            RealtimeSegmentDirectory::ConvertToRtSegmentId(3)) + "_level_0";
    mRtPartitionDir->MakeDirectory(rtSegPath);
    string joinSegPath = string("segment_") + StringUtil::toString(
            JoinSegmentDirectory::ConvertToJoinSegmentId(3)) + "_level_0";
...
void InMemoryIndexCleanerTest::MakeVersions(
        versionid_t incVersionId, const string& incSegmentIds,
        ...
        versionid_t joinVersionId, const string& joinSegmentIds)
{
    ...
    {
        formatedRtSegIds[i] = RealtimeSegmentDirectory::ConvertToRtSegmentId(
                formatedRtSegIds[i]);
    }
    ...
    {
        formatedJoinSegIds[i] = JoinSegmentDirectory::ConvertToJoinSegmentId(
                formatedJoinSegIds[i]);
    }
...
void InMemoryIndexCleanerTest::MakeVersionInDrectory(
