...
public:
    ...
    FakeIndexPartitionReaderBase(config::IndexPartitionSchemaPtr schema,
                                 versionid_t fakeIncVersionId = 0)
...
public:
    ...
    virtual const index::IndexReaderPtr& GetIndexReader(indexid_t indexId) const override
    {return RET_EMPTY_INDEX_READER; }
    ...
    virtual versionid_t GetIncVersionId() const override
    {
        return mFakeIncVersionId;
    }
