...
public:
    ...
    KeyIteratorPtr CreateKeyIterator(const std::string& indexName)
    {
    ...
    {
        return new FakePrimaryKeyReader(*this);
    }

    void AddIndexSegmentReader(
            const index::IndexSegmentReaderPtr& indexSegmentReader)
    {}
    ...
    docid_t LookupWithSegId(const std::string &pkStr,
...
public:
    ...
    FakeIndexReaderForIPR(const FakeIndexReaderForIPR& reader) 
        : FakeIndexReaderBase(reader)
    {
    }
    ~FakeIndexReaderForIPR() {}
...
public:
    ...
    IndexReader* Clone() const
    {
        return new FakeIndexReaderForIPR(*this);
    }

    virtual void AddIndexSegmentReader(
            const index::IndexSegmentReaderPtr& indexSegmentReader)
    {}
};
