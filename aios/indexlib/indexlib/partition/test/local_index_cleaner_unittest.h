...
private:
    void DpToOnline(const std::vector<versionid_t> versionIds,
                    const std::vector<segmentid_t> segmentIds);
    void CheckOnlineVersions(const std::vector<versionid_t>& versionIds,
                             const std::vector<segmentid_t>& segmentIds);
    void Clean(const std::map<versionid_t, index_base::Version>& versions,
               const std::vector<versionid_t>& keepVersionIds,
               const std::vector<versionid_t>& readerContainerHoldVersionIds,
