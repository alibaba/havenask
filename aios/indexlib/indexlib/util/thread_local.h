...
#ifndef __INDEXLIB_THREAD_LOCAL_H
#define __INDEXLIB_THREAD_LOCAL_H
 ...
 protected:
  ...
  class StaticMeta {
   public:
    ...
    autil::ThreadMutex& MemberMutex() { return mutex_; }
...
#endif //__INDEXLIB_THREAD_LOCAL_H
