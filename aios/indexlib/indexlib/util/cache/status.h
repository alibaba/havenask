...
class Status {
 public:
  ...
  static Status NotFound(const autil::ConstString& msg,
                         const autil::ConstString& msg2 = autil::ConstString()) {
    return Status(kNotFound, msg, msg2);
  }
  // Fast path for not found without malloc;
  static Status NotFound(SubCode msg = kNone) { return Status(kNotFound, msg); }

  static Status Corruption(const autil::ConstString& msg,
                           const autil::ConstString& msg2 = autil::ConstString()) {
  ...
  static Status NotSupported(const autil::ConstString& msg,
                             const autil::ConstString& msg2 = autil::ConstString()) {
  ...
  static Status InvalidArgument(const autil::ConstString& msg,
                                const autil::ConstString& msg2 = autil::ConstString()) {
  ...
  static Status IOError(const autil::ConstString& msg,
                        const autil::ConstString& msg2 = autil::ConstString()) {
    return Status(kIOError, msg, msg2);
  }
  static Status IOError(SubCode msg = kNone) { return Status(kIOError, msg); }

  static Status MergeInProgress(const autil::ConstString& msg,
                                const autil::ConstString& msg2 = autil::ConstString()) {
  ...
  static Status Incomplete(const autil::ConstString& msg,
                           const autil::ConstString& msg2 = autil::ConstString()) {
 ...
 private:
  ...
  Status(Code _code, SubCode _subcode, const autil::ConstString& msg, const autil::ConstString& msg2);
  Status(Code _code, const autil::ConstString& msg, const autil::ConstString& msg2)
