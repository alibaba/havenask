#ifndef __INDEXLIB_HASH_UTIL_H
#define __INDEXLIB_HASH_UTIL_H
...
public:
    ...
    {
        return autil::HashAlgorithm::hashString64(key);
    }
};
...
public:
    ...
    {
        return autil::HashAlgorithm::hashString64(key.c_str());
    }
};
...
{
public:
    uint64_t operator()(autil::uint128_t key) const
    {
        return key.value[0];   
    }
};
