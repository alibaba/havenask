...
void DocumentRewriterChainTest::TestAddToUpdate()
{
    ...
    NormalDocumentPtr doc = DocumentCreator::CreateDocument(
            mSchema, "cmd=add,string0=hello,price=32,ts=1234,"
            "modify_fields=price");
...
void DocumentRewriterChainTest::TestAppendSectionAttribute()
{
    ...
    chain.Init();
    NormalDocumentPtr doc = DocumentCreator::CreateDocument(
	schema, "cmd=add,field0=hello_fid0,field1=hello_fid1", false);
...
void DocumentRewriterChainTest::TestAppendPackAttributes()
{
    ...
    const ConstString& packField0 = attrDoc->GetPackField(0);
    const ConstString& packField1 = attrDoc->GetPackField(1);
    chain.Rewrite(doc);
    ASSERT_EQ(size_t(2), attrDoc->GetPackFieldCount());
...
void DocumentRewriterChainTest::TestForKKVDocument()
{
    ...
    NormalDocumentPtr doc = DocumentCreator::CreateDocument(
            schema, "cmd=add,pkey=hello,skey=world,value=10,ts=1234;");
