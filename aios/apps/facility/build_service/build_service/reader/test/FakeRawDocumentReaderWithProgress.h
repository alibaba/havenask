...
class FakeRawDocumentReaderWithProgress : public RawDocumentReader
{
public:
    FakeRawDocumentReaderWithProgress();
    ~FakeRawDocumentReaderWithProgress();

private:
    FakeRawDocumentReaderWithProgress(const FakeRawDocumentReaderWithProgress&);
    FakeRawDocumentReaderWithProgress& operator=(const FakeRawDocumentReaderWithProgress&);
...
BS_TYPEDEF_PTR(FakeRawDocumentReaderWithProgress);
