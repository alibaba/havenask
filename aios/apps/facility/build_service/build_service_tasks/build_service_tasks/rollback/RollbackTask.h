...
class RollbackTask : public Task
{
public:
    RollbackTask();
    ~RollbackTask() {}
...
private:
    bool prepareParams(const config::TaskTarget& target);
    bool prepareTargetVersion();

private:
    RollbackTask(const RollbackTask&) {}
    RollbackTask& operator=(const RollbackTask&) { return *this; }
