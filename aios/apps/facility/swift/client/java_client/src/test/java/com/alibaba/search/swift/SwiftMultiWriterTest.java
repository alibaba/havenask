 ...
 */
public class SwiftMultiWriterTest {
    ...
    public void testMultiWrite() throws Exception {
        String writeConfig = "topicName=" + topicNames[0] + "##topicName=" +topicNames[1];
        ...
        try {
            ...
            String readConfig = "topicName=" + topicNames[0];
            ...
            String readConfig1 = "topicName=" + topicNames[1];
