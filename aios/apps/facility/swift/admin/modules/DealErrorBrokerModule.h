...
class DealErrorBrokerModule : public BaseModule {
public:
    DealErrorBrokerModule();
    ~DealErrorBrokerModule();
    DealErrorBrokerModule(const DealErrorBrokerModule &) = delete;
    DealErrorBrokerModule &operator=(const DealErrorBrokerModule &) = delete;
