 ...
 */
#ifndef __CM_SUB_WEIGHT_ROUND_ROBIN_POLICY_H_
#define __CM_SUB_WEIGHT_ROUND_ROBIN_POLICY_H_
...
class WeightRoundRobinPolicy : public ILBPolicy
{
public:
    WeightRoundRobinPolicy() : ILBPolicy() {}
...
private:
    ...
    std::shared_ptr<WeightedRoundRobin> _wrr;
    std::shared_ptr<RoundRobinPolicy> _rrPolicy;
};

} // namespace cm_sub

#endif // __CM_SUB_WEIGHT_ROUND_ROBIN_POLICY_H_