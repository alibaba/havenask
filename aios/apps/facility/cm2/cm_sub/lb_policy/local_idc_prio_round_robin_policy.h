 ...
 */
#ifndef __CM_SUB_LOCAL_IDC_PRIO_ROUND_ROBIN_POLICY_H_
#define __CM_SUB_LOCAL_IDC_PRIO_ROUND_ROBIN_POLICY_H_
...
class LocalIDCPrioRoundRobinPolicy : public ILBPolicy
{
public:
    LocalIDCPrioRoundRobinPolicy() : ILBPolicy() {}
    ~LocalIDCPrioRoundRobinPolicy() {}
...
#endif // __CM_SUB_LOCAL_IDC_PRIO_ROUND_ROBIN_POLICY_H_