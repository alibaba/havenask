...
namespace suez {
AUTIL_DECLARE_AND_SETUP_LOGGER(suez.drc, KVUpdate2Add);

KVUpdate2Add::KVUpdate2Add() {}

KVUpdate2Add::~KVUpdate2Add() {}

bool KVUpdate2Add::init(indexlibv2::framework::ITablet *index) {
...
KVUpdate2Add::prepareDecoder(const std::shared_ptr<indexlibv2::framework::ITabletReader> &reader) const {
    if (!reader) {
...
RewriteCode KVUpdate2Add::rewrite(LogRecord &log) {
...
bool KVUpdate2Add::createSnapshot() {
...
void KVUpdate2Add::releaseSnapshot() {
