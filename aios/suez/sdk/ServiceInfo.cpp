...
bool ServiceInfo::operator==(const ServiceInfo &info) const {
    return this->_partId == info._partId && this->_partCount == info._partCount && this->_roleName == info._roleName &&
           this->_zoneName == info._zoneName &&
           FastToJsonString(this->_cm2ConfigMap) == FastToJsonString(info._cm2ConfigMap) &&
           FastToJsonString(this->_subCm2ConfigArray) == FastToJsonString(info._subCm2ConfigArray);
}
