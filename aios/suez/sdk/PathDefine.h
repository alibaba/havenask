...
public:
    ...
    static std::string
    getTableConfigPath(const std::string &rootPath, const std::string &tableName, const std::string &partName);
    static std::string getIndexRoot(const std::string &rootPath, const std::string &tableName);
    static std::string getSchemaPath(const std::string &configPath, const std::string &tableName);
    static std::string getDataTablePath(const std::string &configPath, const std::string &tableName);
    static std::string getTableClusterConfigPath(const std::string &configPath, const std::string &tableName);
    static std::string getBuildServiceConfigPath(const std::string &configPath);
    static std::string getBizConfigPath(const std::string &configPath, const std::string &deploymentName);
