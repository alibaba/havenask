...
class SuezIndexPartitionData final : public SuezPartitionData {
public:
    SuezIndexPartitionData(const PartitionId &pid,
                           int32_t totalPartitionCount,
                           const indexlib::partition::IndexPartitionPtr &indexPartition,
                           bool hasRt);
    ~SuezIndexPartitionData();

public:
    const indexlib::partition::IndexPartitionPtr &getIndexPartition() const;
...
using SuezIndexPartitionDataPtr = std::shared_ptr<SuezIndexPartitionData>;
