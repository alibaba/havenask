...
public:
    ...
    SuezAccessLog(const Treq *request, const Tres *response, const std::string funcName)
...
private:
    SuezAccessLog(const SuezAccessLog &);
    SuezAccessLog &operator=(const SuezAccessLog &);
...
AUTIL_LOG_SETUP_TEMPLATE_2(suez, SuezAccessLog, Treq, Tres);
