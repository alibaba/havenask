...
class DefaultCarbonAdapter : public CarbonAdapter {
public:
    DefaultCarbonAdapter(const std::shared_ptr<carbon::RoleManagerWrapper> &roleManager);
    virtual ~DefaultCarbonAdapter();
