...
#ifndef FUTURE_LITE_EXPERIMENTAL_COROUTINE
#define FUTURE_LITE_EXPERIMENTAL_COROUTINE
...
template <class _Tp>
struct __coroutine_traits_sfinae<_Tp, typename future_lite::detail::__void_t<
...
#endif /* FUTURE_LITE_EXPERIMENTAL_COROUTINE */
