 ...
 */
#ifndef FUTURE_LITE_INVOKE_H
#define FUTURE_LITE_INVOKE_H
...
// Until CWG 1558 (a C++14 defect), unused parameters in alias templates were not guaranteed
// to ensure SFINAE and could be ignored, so earlier compilers require a more complex
// definition of void_t, see https://en.cppreference.com/w/cpp/types/void_t
