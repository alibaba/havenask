...
public:
    ...
    MetricPtr registerGaugeMetric(const std::string& name, kmonitor::MetricLevel level, const KVVec& tags = KVVec(),
    ...
    MetricPtr registerMetric(const std::string& name, kmonitor::MetricType metricType, kmonitor::MetricLevel level,
                             const KVVec& tags = KVVec());
