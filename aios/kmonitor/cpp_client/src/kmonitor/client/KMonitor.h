 ...
 * modify:
    ...
    2. 2020-02-06 depart metric and tags to improve perf, refer issue:
 xxxx://invalid/monitor_service/kmonitor-client-cpp/issues/86028
 * */
...
public:
    ...
    void
    registerBuildInMetrics(MetricsTags *tags, MetricLevel level = NORMAL, const std::string &metric_name_prefix = "");
    ...
    // 增加kmonitor级别的tag
    void AddTag(const std::string &k, const std::string &v) { tags_->AddTag(k, v); }
