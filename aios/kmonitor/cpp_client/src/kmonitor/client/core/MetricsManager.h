...
class MetricsManager {
 ...
 public:
    ...
    void Register(const std::string &metric_name, MetricType type, MetricLevel level, MetricsTagsManager* tags_manager, MetricsCache *metricsCache = NULL);
    MutableMetric* RegisterMetric(const std::string &metric_name, MetricType type, MetricLevel level, MetricsTagsManager* tags_manager, MetricsCache *metricsCache = NULL);
