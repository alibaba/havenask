...
#define REGISTER_STATUS_MUTABLE_METRIC_BASE(target, name, level)                                                       \
    REGISTER_MUTABLE_METRIC_BASE(target, name, kmonitor::STATUS, level)

#define REGISTER_QPS_MUTABLE_METRIC_BASE(target, name, level)                                                          \
    REGISTER_MUTABLE_METRIC_BASE(target, name, kmonitor::QPS, level)
...
#define REGISTER_SUMMARY_GAUGE_MUTABLE_METRIC_BASE(target, name, level)                                                \
    REGISTER_MUTABLE_METRIC_BASE(target, name, kmonitor::SUMMARY, level)

#define REGISTER_GAUGE_MUTABLE_METRIC(target, name) REGISTER_GAUGE_MUTABLE_METRIC_BASE(target, name, kmonitor::NORMAL)
...
#define REGISTER_STATUS_MUTABLE_METRIC(target, name) REGISTER_STATUS_MUTABLE_METRIC_BASE(target, name, kmonitor::NORMAL)

#define REGISTER_QPS_MUTABLE_METRIC(target, name) REGISTER_QPS_MUTABLE_METRIC_BASE(target, name, kmonitor::NORMAL)
...
#define REPORT_USER_MUTABLE_QPS(reporter, name) REPORT_USER_MUTABLE_QPS_TAGS(reporter, name, nullptr)
