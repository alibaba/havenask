 ...
 */
#include "sql/framework/SqlErrorAccessLog.h"
...
namespace sql {
AUTIL_LOG_SETUP(sql, SqlErrorAccessLog);

SqlErrorAccessLog::~SqlErrorAccessLog() {
    log();
}

void SqlErrorAccessLog::log() {
