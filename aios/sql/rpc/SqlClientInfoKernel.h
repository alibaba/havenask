...
class SqlClientInfoKernel : public navi::Kernel {
public:
    SqlClientInfoKernel();
    ~SqlClientInfoKernel();
    SqlClientInfoKernel(const SqlClientInfoKernel &) = delete;
    SqlClientInfoKernel &operator=(const SqlClientInfoKernel &) = delete;
