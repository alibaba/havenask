...
def config(config_path, meta_info):
    ...
    config = {
        ...
        "resource_config": [
            ...
            },
            {
                ...
                "config": ({
                    "item_table": sql_utils.get_item_table_name(config_path, zone_name),
    ...
    if has_qrs:
        flow_config_map.update(sql_utils.get_flow_control_config(config_path))
