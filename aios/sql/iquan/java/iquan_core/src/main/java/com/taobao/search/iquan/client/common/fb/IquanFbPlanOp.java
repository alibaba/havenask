...
public final class IquanFbPlanOp extends Table {
    public static IquanFbPlanOp getRootAsIquanFbPlanOp(ByteBuffer _bb) {
        return getRootAsIquanFbPlanOp(_bb, new IquanFbPlanOp());
    }

    public static IquanFbPlanOp getRootAsIquanFbPlanOp(ByteBuffer _bb, IquanFbPlanOp obj) {
    ...
    public static void startIquanFbPlanOp(FlatBufferBuilder builder) {
        builder.startObject(4);
    }
    ...
    public static void addOpName(FlatBufferBuilder builder, int opNameOffset) {
    ...
    public static void addJsonAttrs(FlatBufferBuilder builder, int jsonAttrsOffset) {
        builder.addOffset(3, jsonAttrsOffset, 0);
    }
    ...
    public IquanFbPlanOp __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public IquanFbMap inputs() {
        return inputs(new IquanFbMap());
    }

    public IquanFbMap inputs(IquanFbMap obj) {
        int o = __offset(8);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }

    public IquanFbMap jsonAttrs() {
        return jsonAttrs(new IquanFbMap());
    }

    public IquanFbMap jsonAttrs(IquanFbMap obj) {
        int o = __offset(10);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }
}
