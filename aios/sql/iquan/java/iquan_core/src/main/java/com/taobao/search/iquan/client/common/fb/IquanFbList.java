...
public final class IquanFbList extends Table {
    public static IquanFbList getRootAsIquanFbList(ByteBuffer _bb) {
        return getRootAsIquanFbList(_bb, new IquanFbList());
    }

    public static IquanFbList getRootAsIquanFbList(ByteBuffer _bb, IquanFbList obj) {
    ...
    public static void startIquanFbList(FlatBufferBuilder builder) {
        builder.startObject(1);
    }
    ...
    public IquanFbList __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public IquanFbAny value(int j) {
        return value(new IquanFbAny(), j);
    }

    public IquanFbAny value(IquanFbAny obj, int j) {
        int o = __offset(4);
