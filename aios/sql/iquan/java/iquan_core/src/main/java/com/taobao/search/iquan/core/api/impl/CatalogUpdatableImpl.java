...
public class CatalogUpdatableImpl implements CatalogUpdatable {
    ...
    @Override
    public boolean updateFunction(String catalogName, String dbName, Function function) {
        if (function == null) {
     ...
     * @return null need to retry by user
     */
    private boolean getDatabase(String catalogName, String dbName, GlobalCatalog catalog, boolean createIfNotExists) {
        try {
