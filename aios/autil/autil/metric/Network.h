...
inline double Network::getPksin() const { return (_curStat.pksin - _prevStat.pksin) / _timeDiff; }

inline double Network::getBytesin() const { return (_curStat.bytesin - _prevStat.bytesin) / (double)1024 / _timeDiff; }

inline double Network::getPksout() const { return (_curStat.pksout - _prevStat.pksout) / _timeDiff; }
