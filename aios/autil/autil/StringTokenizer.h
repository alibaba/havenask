...
public:
    StringTokenizer(const std::string &str, const std::string &sep, Option opt = TOKEN_LEAVE_AS);
    StringTokenizer();
    ~StringTokenizer();

public:
    size_t tokenize(const std::string &str, const std::string &sep, Option opt = TOKEN_LEAVE_AS);
...
public:
    // new implement begin
    static std::vector<StringView>
    constTokenize(const StringView &str, const std::string &sep, Option opt = TOKEN_IGNORE_EMPTY | TOKEN_TRIM);

    static std::vector<StringView>
    constTokenize(const StringView &str, char c, Option opt = TOKEN_IGNORE_EMPTY | TOKEN_TRIM);

    static std::vector<std::string>
    tokenize(const StringView &str, const std::string &sep, Option opt = TOKEN_IGNORE_EMPTY | TOKEN_TRIM);

    static std::vector<std::string>
    tokenize(const StringView &str, char c, Option opt = TOKEN_IGNORE_EMPTY | TOKEN_TRIM);
...
inline StringTokenizer::Iterator StringTokenizer::begin() const { return m_tokens.begin(); }

inline StringTokenizer::Iterator StringTokenizer::end() const { return m_tokens.end(); }
...
inline size_t StringTokenizer::getNumTokens() const { return m_tokens.size(); }

inline const StringTokenizer::TokenVector &StringTokenizer::getTokenVector() const { return m_tokens; }
