...
string ExtendHashFunction::extendMd5(uint8_t md[16])
{
    ...
    //byte order should be taken into consideration, for simplicity, we adopt __LITTLE_ENDIDAN, which puts significant byte at high address, it is compatible with Intel x86 CPUs but not PowerPC!!!
