...
#define GET_VARINT32(curr, tail, pointer)                                                                              \
    if (curr < tail) {                                                                                                 \
        ...
        if (curr < tail) {                                                                                             \
            uint32_t byteRoom;                                                                                         \
            ParseOneByteVarint(pointer, 2) if (curr < tail) {                                                          \
                ParseOneByteVarint(pointer, 3) if (curr < tail) {                                                      \
                    ParseOneByteVarint(pointer, 4) if (curr < tail) { ParseOneByteVarint(pointer, 5) }                 \
                }                                                                                                      \
            }                                                                                                          \
        }                                                                                                              \
    }
...
#define GET_VARINT64(curr, tail, pointer)                                                                              \
    if (curr < tail) {                                                                                                 \
        ...
        if (curr < tail) {                                                                                             \
            ...
            ParseOneByteVarint(pointer, 2) if (curr < tail) {                                                          \
                ParseOneByteVarint(pointer, 3) if (curr < tail) {                                                      \
                    ParseOneByteVarint(pointer, 4) if (curr < tail) {                                                  \
                        ParseOneByteVarint(pointer, 5) if (curr < tail) {                                              \
                            ParseOneByteVarint(pointer, 6) if (curr < tail) {                                          \
                                ParseOneByteVarint(pointer, 7) if (curr < tail) {                                      \
                                    ParseOneByteVarint(pointer, 8) if (curr < tail) {                                  \
                                        ParseOneByteVarint(pointer, 9) if (curr < tail) {                              \
...
#define DECODE_VARINT32_DIRECTLY(curr)                                                                                 \
    ...
    uint32_t byteRoom;                                                                                                 \
    ParseOneByteVarint(curr++, 2) ParseOneByteVarint(curr++, 3) ParseOneByteVarint(curr++, 4)                          \
...
#define DECODE_VARINT64_DIRECTLY(curr)                                                                                 \
    ...
    uint64_t byteRoom;                                                                                                 \
    ParseOneByteVarint(curr++, 2) ParseOneByteVarint(curr++, 3) ParseOneByteVarint(curr++, 4)                          \
        ParseOneByteVarint(curr++, 5) ParseOneByteVarint(curr++, 6) ParseOneByteVarint(curr++, 7)                      \
            ParseOneByteVarint(curr++, 8) ParseOneByteVarint(curr++, 9) ParseOneByteVarint(curr++, 10)
