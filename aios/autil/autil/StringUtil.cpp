...
void StringUtil::sundaySearch(
    const char *text, size_t textSize, const char *key, size_t keySize, vector<size_t> &posVec) {
    posVec.clear();
...
void StringUtil::getKVValue(const string &text, string &key, string &value, const string &sep, bool isTrim) {
    size_t n;
