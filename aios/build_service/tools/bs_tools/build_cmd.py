...
examples:
    ...
    def _transformDataDesc(self, configPath, dataTable,
        ...
        if dataDescriptionKv is not None:
            ...
            cmdDataDescriptions = json.loads(self.fsUtil.cat(dataDescriptionFile))
    ...
    def run(self):
        ...
        print json.dumps(pb2json(response), format=True)
