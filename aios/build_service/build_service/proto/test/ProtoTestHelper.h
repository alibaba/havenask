...
public:
    static BuilderTarget createBuilderTarget(
            const std::string &configPath = "/path/to/config",
            int64_t startFromCheckpoint = 0,
            int64_t stopToCheckpoint = 0);

    static BuilderCurrent createBuilderCurrent(
