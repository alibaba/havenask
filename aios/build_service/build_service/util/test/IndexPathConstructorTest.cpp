...
TEST_F(IndexPathConstructorTest, testConstructIndexPath) {
    string indexRoot = TEST_DATA_PATH"index_path_constructor_test";
    ...
    string rangeTo = "1";
    {
        ...
        string result = IndexPathConstructor::getGenerationId(
                indexRoot, emptyClusterName, buildMode, rangeFrom, rangeTo);
        EXPECT_EQ("0", result);
    }
    {
        ...
        string buildMode = "full";
        string result = IndexPathConstructor::getGenerationId(
                indexRoot, clusterName, buildMode, rangeFrom, rangeTo);
        EXPECT_EQ("1", result);
    }
    {
    ...
    }
    {
        ...
        string buildMode = "not_full";
        string result = IndexPathConstructor::getGenerationId(
                indexRoot, emptyClusterName, buildMode, "5", "6");
        EXPECT_EQ("", result);
    }
    {
        ...
        string buildMode = "not_full";
        string result = IndexPathConstructor::getGenerationId(
                indexRoot, "partition_cluster", buildMode, "0", "2");
        EXPECT_EQ("1", result);
    }
    {
        // not full mode, partition consistent
        string buildMode = "not_full";
        string result = IndexPathConstructor::getGenerationId(
                indexRoot, "partition_cluster", buildMode, "2", "3");
        EXPECT_EQ("0", result);
    }
    {
        // not full mode, partition consistent
        string buildMode = "not_full";
        string result = IndexPathConstructor::getGenerationId(
                indexRoot, "partition_cluster", buildMode, "3", "4");
        EXPECT_EQ("1", result);
    }
}
...
TEST_F(IndexPathConstructorTest, testGetGenerationList) {
    string indexRoot = TEST_DATA_PATH"index_path_constructor_test";
    {
        ...
        vector<int32_t> gens = IndexPathConstructor::getGenerationList(
...
TEST_F(IndexPathConstructorTest, testGetNextGenerationId) {
    string indexRoot = TEST_DATA_PATH"index_path_constructor_test";
    {
        ...
        EXPECT_EQ(generationid_t(0), IndexPathConstructor::getNextGenerationId(
                        indexRoot, clusterName));
    }
    {
        string clusterName = "partition_cluster";
        EXPECT_EQ(generationid_t(2), IndexPathConstructor::getNextGenerationId(
                        indexRoot, clusterName));
    }
}
...
TEST_F(IndexPathConstructorTest, testGetMergerCheckpointPath) {
    ...
    string rangeFrom = "0";
    string rangeTo = "1";
    auto pid = ProtoCreator::createPartitionId(
            ROLE_MERGER, BUILD_STEP_FULL, 0, 2047, "simple", 1, clusterName);
