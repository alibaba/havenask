...
TEST_F(CounterSynchronizerTest, testGetCounterZkFilePath) {
...

    {
        ...
        ASSERT_TRUE(CounterSynchronizer::getCounterZkFilePath(
                        appZkRoot, pid, counterFilePath));

        EXPECT_EQ(string("zfs://testAppZkRoot/generation.app.simple.666/counter/app.simple.666.processor.full.0.32767"), counterFilePath);
    }
    {
        pid.set_role(ROLE_BUILDER);
        pid.set_step(BUILD_STEP_FULL);
        *pid.add_clusternames() = "cluster1";
        ...
        ASSERT_TRUE(CounterSynchronizer::getCounterZkFilePath(
                        appZkRoot, pid, counterFilePath));
        EXPECT_EQ(string("zfs://testAppZkRoot/generation.app.simple.666/counter/app.simple.666.builder.full.0.32767.cluster1"), counterFilePath);        
    }
    {
        pid.set_role(ROLE_MERGER);
        pid.set_step(BUILD_STEP_FULL);
        ...
        *pid.add_clusternames() = "cluster1";
        ...
        ASSERT_TRUE(CounterSynchronizer::getCounterZkFilePath(
                        appZkRoot, pid, counterFilePath));
        EXPECT_EQ(string("zfs://testAppZkRoot/generation.app.simple.666/counter/app.simple.666.merger.inc_1.0.32767.cluster1"), counterFilePath); 
    }
    // test for schema updatable cluster
    {
        ...
        *pid.mutable_taskid() = "1-clusterName=cluster1";
        ...
        ASSERT_TRUE(CounterSynchronizer::getCounterZkFilePath(
                        appZkRoot, pid, counterFilePath));
        EXPECT_EQ(string("zfs://testAppZkRoot/generation.app.simple.666/counter/app.simple.666.processor.inc.0.32767.cluster1"), counterFilePath);
        
        *pid.mutable_taskid() = "1-2-clusterName=cluster1";
        ASSERT_TRUE(CounterSynchronizer::getCounterZkFilePath(
                        appZkRoot, pid, counterFilePath));
        EXPECT_EQ(string("zfs://testAppZkRoot/generation.app.simple.666/counter/app.simple.666.processor.inc.0.32767.cluster1.2"), counterFilePath);

        // for default processor group
        *pid.mutable_taskid() = "1";
        ASSERT_TRUE(CounterSynchronizer::getCounterZkFilePath(
                        appZkRoot, pid, counterFilePath));
        EXPECT_EQ(string("zfs://testAppZkRoot/generation.app.simple.666/counter/app.simple.666.processor.inc.0.32767"), counterFilePath);
        
        *pid.mutable_taskid() = "1-3";
        ASSERT_TRUE(CounterSynchronizer::getCounterZkFilePath(
                        appZkRoot, pid, counterFilePath));
        EXPECT_EQ(string("zfs://testAppZkRoot/generation.app.simple.666/counter/app.simple.666.processor.inc.0.32767.3"), counterFilePath);
