#ifndef ISEARCH_BS_TASKTARGET_H
#define ISEARCH_BS_TASKTARGET_H
...
public:
    ...
    void updateTargetDescription(const std::string& key, const std::string& value)
    {
