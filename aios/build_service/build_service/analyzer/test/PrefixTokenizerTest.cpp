...
public:
    ...
    void tearDown();
protected:
    void innerTestTokenize(const string &str, uint32_t maxTokenNum,
                           bool includeSelf, const string &expectedTokensStr);
};
...
TEST_F(PrefixTokenizerTest, testInit) {
    ...
    ASSERT_EQ(false, tokenizer._includeSelf);
    ...
    ASSERT_EQ(true, tokenizer._includeSelf);
...
TEST_F(PrefixTokenizerTest, testTokenize) {
    ...
    innerTestTokenize("我我我我我我我我", 8, true, "我,我我,我我我,我我我我,我我我我我,我我我我我我,我我我我我我我,我我我我我我我我");
...
TEST_F(PrefixTokenizerTest, testTokenizeNonUtf8) {
    PrefixTokenizer tokenizer;
    string rawDocFile = string(TEST_DATA_PATH) + "/rawdoc.gb18030";
    string content;
    ASSERT_TRUE(FileUtil::readFile(rawDocFile, content));
...
void PrefixTokenizerTest::innerTestTokenize(
