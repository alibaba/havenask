...
public:
    ...
    void tearDown();
protected:
    void checkWSResult(const std::string &oriText,
                       const std::string &checkText,
                       const std::vector<int32_t> &checkVec =
                       std::vector<int32_t>());
};
...
void SingleWSScannerTest::checkWSResult(const string &oriText,
                                        const string &checkText,
                                        const vector<int32_t> &checkVec)
{
