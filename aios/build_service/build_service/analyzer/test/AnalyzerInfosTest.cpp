...
void AnalyzerInfosTest::checkAnalyzerInfo(AnalyzerInfos &analyzerInfos) {
    ...
    ASSERT_EQ(false, normalizeOptions1.caseSensitive);
    ASSERT_EQ(true, normalizeOptions1.traditionalSensitive);
    ASSERT_EQ(true, normalizeOptions1.widthSensitive);
    ...
    ASSERT_EQ(true, normalizeOptions2.caseSensitive);
    ASSERT_EQ(true, normalizeOptions2.traditionalSensitive);
    ASSERT_EQ(true, normalizeOptions2.widthSensitive);
