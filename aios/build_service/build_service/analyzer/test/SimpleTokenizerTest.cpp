...
public:
    ...
    void tearDown();
protected:
    void assertToken(const std::string &tokenStr, int32_t position,
                     Tokenizer* tokenizerPtr, bool isDelimiter = false);
...
void SimpleTokenizerTest::assertToken(const string &tokenStr,
                                      int32_t position,
...
void SimpleTokenizerTest::setUp() {
    _tokenizer = new SimpleTokenizer(string(" "));
}

void SimpleTokenizerTest::tearDown() {
...
TEST_F(SimpleTokenizerTest, testTokenizeChineseString) {
    ...
    str = "\345\233\255\345\214\272\345\244\252\345\244\247\345\256\271\346\230\223\350\277\267\350\267\257\357\274\214\"\345\257\274\350\210\252\345\234\250\346\211\213\"\\\345\276\210\351\207\215\350\246\201\345\223\246!";
    tokenizer.tokenize(str.data(), str.size());
    assertToken("\345\233\255\345\214\272\345\244\252\345\244\247\345\256\271\346\230\223\350\277\267\350\267\257\357\274\214\"\345\257\274\350\210\252\345\234\250\346\211\213\"\\\345\276\210\351\207\215\350\246\201\345\223\246!", 0, &tokenizer);
    ASSERT_TRUE(!tokenizer.next(_token));
...
TEST_F(SimpleTokenizerTest, testClone) {
    ...
    assertToken("Hello", 0, _tokenizer);
    assertToken(" ", 1, _tokenizer, true);
    Tokenizer* newTokenizer = _tokenizer->clone();
    assertToken("World,", 2, _tokenizer);
