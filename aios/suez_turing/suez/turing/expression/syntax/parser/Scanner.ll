...
using namespace suez_turing_bison;
...
%option c++
%option noyywrap
%option prefix="suez_turing_expr_scanner"
...
"?" {
    AUTIL_LOG(TRACE2, "|%s|QUESTION|",YYText());
    return token::QUESTION;
}

":" {
    AUTIL_LOG(TRACE2, "|%s|COLON|",YYText());
    return token::COLON;
}
