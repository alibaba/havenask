 ...
 */
#ifndef ISEARCH_EXPRESSION_RAPIDJSONHELPER_H
#define ISEARCH_EXPRESSION_RAPIDJSONHELPER_H
                                  ...
                                  const T &defaultValue)
{
    ...
    SimpleValue::ConstMemberIterator iter = doc.FindMember(key.c_str());
...
#endif //ISEARCH_EXPRESSION_RAPIDJSONHELPER_H
