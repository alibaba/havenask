...
#define FSLIB_LONG_INTERVAL_LOG_INTERVAL(interval, format, args...)                                                    \
    ...
    (void)snprintf(__fslib_long_interval_log_buf, sizeof(__fslib_long_interval_log_buf), format, ##args);              \
    fslib::util::LongIntervalLog __longItervalLog(                                                                     \
        __FILE__, __LINE__, __FUNCTION__, __fslib_long_interval_log_buf, interval, _logger);

#define FSLIB_LONG_INTERVAL_LOG(format, args...) FSLIB_LONG_INTERVAL_LOG_INTERVAL((1000 * 1000), format, ##args)
