...
void printFsUtilCmdUsage() {
    cout << endl
         ...
         <<"  fs_util encrypt /path/raw_file /path/enc_file \'type=aes-128-cbc;digist=md5;passwd=enl3MDA3\' --base64 " << endl
         <<"  fs_util decrypt /path/enc_file /path/dec_file \'type=aes-128-cbc;digist=md5;passwd=password_term\' " << endl
...
ErrorCode processCmd(int argc, char** argv) {
    if (argc >= 2) {
        ...
        } else if (strcmp(argv[1], FsUtil::MOVE_CMD.c_str()) == 0 &&
                   argc == 4) 
        {
            return FsUtil::runMove(argv[2], argv[3]);
        } else if (strcmp(argv[1], FsUtil::RENAME_CMD.c_str()) == 0 &&
                   argc == 4) 
        {
        ...
        } else if (strcmp(argv[1], FsUtil::REMOVE_CMD.c_str()) == 0 &&
                   argc == 3) 
        {
        ...
        } else if (strcmp(argv[1], FsUtil::MD5_SUM_CMD.c_str()) == 0 &&
                   argc == 3) 
        {
            return FsUtil::runMd5Sum(argv[2]);
        } else if (strcmp(argv[1], FsUtil::ZCAT_CMD.c_str()) == 0 &&
                   argc == 3) 
        {
        ...
        } else if (strcmp(argv[1], FsUtil::FLOCK_CMD.c_str()) == 0 &&
                   argc == 4)
        {
            return FsUtil::runFlock(argv[2], argv[3]);
        } else if (strcmp(argv[1], FsUtil::FORWARD_CMD.c_str()) == 0 &&
                   (argc == 4 || argc == 5))
        {
