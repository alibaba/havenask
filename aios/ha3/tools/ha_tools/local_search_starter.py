...
examples:
    ...
    def startSearcher(self):
        ...
        return self._loadSearcherTarget(tableInfos, self.timeout)
            ...
            for partition in partitions:
                ...
                if self.enableMultiBiz:
                    ...
                    "biz_info" : {
                        ...
                        self.multiBiz : {
                            "config_path" : self.createConfigLink(zoneName + "_" + str(partId), 'biz', self.multiBiz, self.onlineConfigPath)
                        }
                    },
                    "clean_disk" : False
                }
                    targetInfos.append((zoneName, partId, targetInfo_multiBiz))
                else:
