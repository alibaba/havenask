...
%parse-param {isearch::queryparser::Scanner &scanner}
...
%union {
    ...
    isearch::common::RequiredFields *requiredFieldsVal;
    isearch::queryparser::QueryExpr *queryExprVal;
    isearch::queryparser::AtomicQueryExpr *atomicExprVal;
}
            ...
            | '(' boost_terms ')' '^' NUMBER
              {
                  ...
                  delete $5;
                  auto expr = dynamic_cast<isearch::queryparser::MultiTermQueryExpr*>($2);
                  if (expr) {
...
and_field_identifier : IDENTIFIER RPARENT_COLON
                       {
                           $$ = new isearch::common::RequiredFields;
                           $$->isRequiredAnd = true;
                           std::string *field = $1;
...
void isearch_bison::BisonParser::error(
        ...
        const std::string& m)
{
    ctx.setStatus(isearch::queryparser::ParserContext::SYNTAX_ERROR);
    ctx.setStatusMsg(m);
}
