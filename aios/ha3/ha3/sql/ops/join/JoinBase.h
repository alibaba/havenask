...
struct JoinBaseParam {
    ...
    JoinBaseParam(const std::vector<std::string> &leftInputFields,
                  ...
                  std::unique_ptr<CalcTable> calcTable)
...
public:
    virtual bool generateResultTable(const std::vector<size_t> &leftTableIndexes,
        ...
        = 0;
    virtual bool finish(const table::TablePtr &leftTable, size_t offset, table::TablePtr &outputTable) {
        return true;
    }
...
protected:
    ...
    bool evaluateLeftTableColumns(const std::vector<size_t> &rowIndexes,
                                  ...
                                  size_t joinIndexStart, table::TablePtr &outputTable);
    bool evaluateEmptyColumns(size_t fieldIndex, size_t joinIndexStart,
                              table::TablePtr &outputTable);
    bool appendColumns(const table::TablePtr &inputTable,
...
private:
    ...
    bool declareTableColumn(const table::TablePtr &inputTable,
                            table::TablePtr &outputTable, const std::string &inputField,
