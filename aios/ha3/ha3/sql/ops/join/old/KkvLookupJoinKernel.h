#ifndef ISEARCH_KKV_LOOKUP_JOIN_KERNEL_H
#define ISEARCH_KKV_LOOKUP_JOIN_KERNEL_H
...
class KkvLookupJoinKernel : public LookupJoinKernel {
public:
    KkvLookupJoinKernel();
    ~KkvLookupJoinKernel();
public:
...
private:
    std::string _kkvTableName;
    IE_NAMESPACE(index)::KKVReaderPtr _kkvReader;
    ValueCollectorPtr _valueCollectorPtr;
};

HA3_TYPEDEF_PTR(KkvLookupJoinKernel);

END_HA3_NAMESPACE(sql);

#endif //ISEARCH_KKV_LOOK_UP_JOIN_KERNEL_H
