...
void PrimaryKeyScanConditionVisitorTest::getFieldAndIndexName(std::string& fieldName, std::string& indexName) {
...
TEST_F(PrimaryKeyScanConditionVisitorTest, testVisitLeafCondition) {
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr ="{\"op\":\"contain\", \"params\":[\"$attr1\", \"100|200\"],\"type\":\"UDF\"}";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
...
TEST_F(PrimaryKeyScanConditionVisitorTest, testParseIn) {
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr = R"json({"op":"IN","params":["$attr1",{"cast_type":"BIGINT","op":"CAST","params":[100],"type":"UDF"}, 200],"type":"OTHER"})json";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr = R"json({"op":"IN","params":["$attr1", {"cast_type":"BIGINT","op":"CAST","params":["100"],"type":"UDF"},{"cast_type":"BIGINT","op":"CAST","params":[200],"type":"UDF"}],"type":"OTHER"})json";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
...
TEST_F(PrimaryKeyScanConditionVisitorTest, testParseUdf) {
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr ="{\"op\":\"contain\", \"params\":[\"attr1_idx\", \"100|200\"],\"type\":\"UDF\"}";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr ="{\"op\":\"contain\", \"params\":[\"xxxxxx\", \"100|200\"],\"type\":\"UDF\"}";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr ="{\"op\":\"ha_in\", \"params\":[\"attr1_idx\", \"100|200\"],\"type\":\"UDF\"}";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr ="{\"op\":\"ha_in\", \"params\":[\"xxxxxx\", \"100|200\"],\"type\":\"UDF\"}";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
...
TEST_F(PrimaryKeyScanConditionVisitorTest, testParsePk) {
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr = R"json({"op":"=","params":[{"cast_type":"BIGINT","op":"CAST","params":["$attr1"],"type":"UDF"},601761753904],"type":"OTHER"})json";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
         std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr = R"json({"op":"=","params":["$attr1",{"cast_type":"BIGINT","op":"CAST","params":[601761753904],"type":"UDF"}],"type":"OTHER"})json";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr = R"json({"op":"=","params":[{"cast_type":"BIGINT","op":"CAST","params":["$attr1"],"type":"UDF"},{"cast_type":"BIGINT","op":"CAST","params":[601761753904],"type":"UDF"}],"type":"OTHER"})json";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr = R"json({"op":"IN","params":["$attr1",{"cast_type":"BIGINT","op":"CAST","params":[1],"type":"UDF"}],"type":"OTHER"})json";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr = R"json({"op":"IN","params":["notkey",{"cast_type":"BIGINT","op":"CAST","params":[1],"type":"UDF"}],"type":"OTHER"})json";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
    ...
    {
        autil_rapidjson::SimpleDocument simpleDoc;
        string condStr = R"json({"op":"IN","params":["$nid", {"hello": "world"}],"type":"OTHER"})json";
        simpleDoc.Parse(condStr.c_str());
        ASSERT_FALSE(simpleDoc.HasParseError());
        LeafCondition cond(simpleDoc);
        std::string fieldName;
