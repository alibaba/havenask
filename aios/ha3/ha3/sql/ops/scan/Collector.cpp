...
////////////////////////////////////////////////////////////////////////
AUTIL_LOG_SETUP(sql, KeyCollector);
...
////////////////////////////////////////////////////////////////////////
AUTIL_LOG_SETUP(sql, ValueCollector);
...
bool ValueCollector::init(const std::shared_ptr<indexlibv2::config::ValueConfig> &valueConfig,        
    ...
    assert(mountedAllocator);
    bool isMountRef = true;
    std::vector<std::shared_ptr<indexlibv2::config::FieldConfig>> attrFields(valueConfig->GetAttributeCount());
    const auto &attrConfigs = valueConfig->GetAttributeConfigs();
    std::transform(attrConfigs.begin(), attrConfigs.end(), attrFields.begin(), [](const auto &attrConfig) {
        return attrConfig->GetFieldConfig();
    });
...
//         matchdoc::MatchDoc matchDoc, indexlib::index::KKVIterator* iter)
// {
//     assert(_tsRef);
//     assert(iter && iter->IsValid());
...
////////////////////////////////////////////////////////////////////////
AUTIL_LOG_SETUP(sql, CollectorUtil);
