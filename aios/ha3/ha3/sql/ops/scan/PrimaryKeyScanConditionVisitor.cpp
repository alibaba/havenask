...
namespace isearch {
namespace sql {
AUTIL_LOG_SETUP(sql, PrimaryKeyScanConditionVisitor);
...
/**
AUTIL_LOG_SETUP(sql, SummaryScanConditionVisitor);
AUTIL_LOG_SETUP(sql, KVScanConditionVisitor);
AUTIL_LOG_SETUP(sql, KKVScanConditionVisitor);
*/
