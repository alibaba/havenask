...
public:
    ...
    static std::pair<suez::turing::VariableType, bool> transSqlTypeToVariableType(const std::string &sqlTypeStr);
...
public:
    ...
    static bool isSameUdf(const autil::SimpleValue &simpleVal,
                          const std::string &udfType);
    ...
    static std::string toExprString(const autil::SimpleValue &simpleVal,
                                    ...
                                    std::unordered_map<std::string, std::string> &renameMap);
    static bool createExprString(const autil::SimpleValue &simpleVal,
                                 std::string &exprStr);
    template <typename T>
    static suez::turing::AttributeExpression *
    ...
    static bool parseItemVariable(const autil::SimpleValue &item,
                                  std::string &itemName,
                                  std::string &itemKey);
