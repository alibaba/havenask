...
std::pair<suez::turing::VariableType, bool> ExprUtil::transSqlTypeToVariableType(const string &sqlTypeStr) {
...
bool ExprUtil::createExprString(const autil::SimpleValue &simpleVal,
                                std::string &exprStr) {
    std::unordered_map<std::string, std::string> renameMap;
