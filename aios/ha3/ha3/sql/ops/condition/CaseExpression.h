...
{
public:
    CaseExpression(const std::vector<CaseTuple<OutputType> > &caseTuples, OutputExpr<OutputType>* elseExpr)
...
CaseExpressionCreator::CreateOutputExpr(suez::turing::AttributeExpression* expr, autil::mem_pool::Pool* pool)
{
...
#define CREATE_OUTPUT_EXPR(vt_type)                                     \
    ...
    {                                                                   \
        using ExprType =                                                \
            suez::turing::VariableTypeTraits<vt_type, false>::AttrExprType; \
...
CaseExpressionCreator::CreateOutputExpr(suez::turing::AttributeExpression* expr, autil::mem_pool::Pool* pool)
{
    ...
    switch(type)
    {
        ...
        {                                                                   
            using ExprType =                                                
                suez::turing::VariableTypeTraits<vt_string, false>::AttrExprType; 
            suez::turing::AttributeExpressionTyped<ExprType>* exprTyped     
                = dynamic_cast<suez::turing::AttributeExpressionTyped<ExprType>* >(expr); 
            if (NULL == exprTyped) {                                        
                return NULL;                                                
...
template<typename OutputType>
inline bool CaseExpression<OutputType>::operator == (
