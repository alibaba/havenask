...
TEST_F(RequestTest, testMultiSerialize) { 
    ...
    partIds.push_back((hashid_t)1);
    partIds.push_back((hashid_t)3);
...
TEST_F(RequestTest, testParseAndSerializeAggClause) {
    ...
    clusterConfigInfo->_hashMode._hashField = "any";
