...
bool operator==(const PartitionID &lhs, const PartitionID &rhs) {
    return PROTO_MEMBER_EQUAL_HELPER(clustername)
        && PROTO_MEMBER_EQUAL_HELPER(majorconfigversion)
        && PROTO_MEMBER_EQUAL_HELPER(role)
        && PROTO_MEMBER_EQUAL_HELPER(fullversion)
...
bool operator==(const Range &lhs, const Range &rhs) {
    return PROTO_MEMBER_EQUAL_HELPER(from)
        && PROTO_MEMBER_EQUAL_HELPER(to);
}
