#ifndef ISEARCH_SUBSIMPLEMATCHDATAFETCHER_H
#define ISEARCH_SUBSIMPLEMATCHDATAFETCHER_H
...
HA3_TYPEDEF_PTR(SubSimpleMatchDataFetcher);

END_HA3_NAMESPACE(search);

#endif //ISEARCH_SUBSIMPLEMATCHDATAFETCHER_H
