...
HA3_LOG_SETUP(search, QueryExecutorConstructor);
using namespace std;
...
TermQueryExecutor* QueryExecutorConstructor::prepareTermQueryExecutor(
        autil::mem_pool::Pool *pool, const char *word,
        const char *indexName, IndexPartitionReaderWrapper *indexReaderWrapper, int32_t boost)
{
...
QueryExecutor* QueryExecutorConstructor::preparePhraseQueryExecutor(
        autil::mem_pool::Pool *pool, IndexPartitionReaderWrapper *indexReaderWrapper,
        const char* indexName, const char *str1, const char *str2,
        const char *str3, int32_t boost, bool stop1, bool stop2, bool stop3)
{
...
QueryExecutor* QueryExecutorConstructor::prepareAndQueryExecutor(
        autil::mem_pool::Pool *pool, IndexPartitionReaderWrapper *indexReaderWrapper,
        const char* indexName, const char *str1, const char *str2,
        const char *str3, int32_t boost)
{
    AndQuery andQuery("");
    return prepareQueryExecutor(pool, indexReaderWrapper, indexName, str1, str2, str3,
                                &andQuery, boost);
}

QueryExecutor* QueryExecutorConstructor::prepareOrQueryExecutor(
        autil::mem_pool::Pool *pool, IndexPartitionReaderWrapper *indexReaderWrapper,
        const char* indexName, const char *str1, const char *str2,
        const char *str3, int32_t boost)
{
...
QueryExecutor* QueryExecutorConstructor::prepareRankQueryExecutor(
        autil::mem_pool::Pool *pool, IndexPartitionReaderWrapper *indexReaderWrapper,
        const char* indexName, const char *str1, const char *str2,
        const char *str3, int32_t boost)
{
...
QueryExecutor* QueryExecutorConstructor::prepareMultiTermQueryExecutor(
        ...
        Query *query, int32_t boost, uint32_t minShouldMatch)
{
...
QueryExecutor* QueryExecutorConstructor::prepareQueryExecutor(
        autil::mem_pool::Pool *pool, IndexPartitionReaderWrapper *indexReaderWrapper,
        const char* indexName, const char *str1, const char *str2,
        const char *str3, Query *query, int32_t boost)
{
    RequiredFields requiredFields;
    if (str1) {
...
QueryExecutor* QueryExecutorConstructor::preparePhraseQueryExecutor(
        autil::mem_pool::Pool *pool,
        IndexPartitionReaderWrapper *indexReaderWrapper,
        const char* indexName, const vector<string>& strVec,
        const vector<bool>& posVec,int32_t boost,
...
QueryExecutor* QueryExecutorConstructor::prepareMultiTermAndQueryExecutor(
        ...
        IndexPartitionReaderWrapper *indexReaderWrapper,
        const char* indexName, const char *str1,
        const char *str2, const char *str3, int32_t boost)
{
    MultiTermQuery multiTermQuery("");
    multiTermQuery.setOPExpr(OP_AND);
    return prepareMultiTermQueryExecutor(pool, indexReaderWrapper, indexName,
            str1, str2, str3, (Query*)&multiTermQuery, boost);
}
...
QueryExecutor* QueryExecutorConstructor::prepareWeakAndQueryExecutor(
        ...
        IndexPartitionReaderWrapper *indexReaderWrapper,
        const char* indexName, const char *str1,
        const char *str2, const char *str3, int32_t boost, uint32_t minShouldMatch)
{
    MultiTermQuery multiTermQuery("");
    multiTermQuery.setOPExpr(OP_WEAKAND);
    return prepareMultiTermQueryExecutor(pool, indexReaderWrapper, indexName,
            str1, str2, str3,
            (Query*)&multiTermQuery, boost, minShouldMatch);
}

QueryExecutor* QueryExecutorConstructor::createQueryExecutor(
        autil::mem_pool::Pool *pool, IndexPartitionReaderWrapper *wrapper, Query *query)
{
    MatchDataManager manager;
