...
public:
    virtual matchdoc::ReferenceBase *require(matchdoc::MatchDocAllocator *allocator,
            const std::string &refName, uint32_t termCount) = 0;

    virtual indexlib::index::ErrorCode fillMatchData(const SingleLayerExecutors &singleLayerExecutors,
