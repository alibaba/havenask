...
void CarbonMaster::doInitOptions() {
    ...
    optionParser.addOption("-a", "--appId", "appId",
                            OptionParser::OPT_STRING, true);
    optionParser.addOption("", "--proxySpec", "proxySpec",
                            OptionParser::OPT_STRING, true);
    optionParser.addOption("", "--kmonSpec", "kmonSpec",
                           DEFAULT_KMON_SPEC);
...
void CarbonMaster::doExtractOptions() {
    ...
    optionParser.getOptionValue("proxySpec", _proxySpec);
    optionParser.getOptionValue("kmonSpec", _kmonSpec);
}
...
bool CarbonMaster::start() {
    ...
    if (!_carbonDriverPtr->init(_appId, _hippoZkPath, _zkPath,
                                _backupRoot, getLeaderElector(),
                                _proxySpec, _kmonSpec, DriverOptions()))
    {
