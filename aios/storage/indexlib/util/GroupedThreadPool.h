...
public:
    ...
    void Start(const std::string& name, size_t threadNum, size_t maxGroupCount, size_t maxBatchCount);
...
private:
    static const std::string EXCEED_LIMIT_GROUP_NAME;
