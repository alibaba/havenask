...
class SourceDocInfoExtractor : public indexlibv2::document::extractor::IDocumentInfoExtractor
{
public:
    SourceDocInfoExtractor(const std::shared_ptr<config::IIndexConfig>& indexConfig);
    ~SourceDocInfoExtractor() = default;
