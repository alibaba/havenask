...
class SummaryDocInfoExtractor : public indexlibv2::document::extractor::IDocumentInfoExtractor
{
public:
    SummaryDocInfoExtractor(const std::shared_ptr<config::IIndexConfig>& indexConfig);
    ~SummaryDocInfoExtractor() = default;
