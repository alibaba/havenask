...
const std::string SOURCE_GROUP_CONFIG_MODULE = "module";
const std::string SOURCE_GROUP_CONFIG_MODULE_PARAMS = "module_params";

const std::string SOURCE_CONFIG_MODULES = "modules";
