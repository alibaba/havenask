 ...
 */
#ifndef __INDEXLIB_CONDITION_FILTER_IMPL_H
#define __INDEXLIB_CONDITION_FILTER_IMPL_H
...
DEFINE_SHARED_PTR(ConditionFilterImpl);
}} // namespace indexlib::config

#endif //__INDEXLIB_CONDITION_FILTER_IMPL_H
