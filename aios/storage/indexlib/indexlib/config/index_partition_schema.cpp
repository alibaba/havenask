...
string IndexPartitionSchema::GetSchemaFileName(schemavid_t schemaId)
{
...
void IndexPartitionSchema::AddSummaryConfig(const string& fieldName, summarygroupid_t summaryGroupId, regionid_t id)
{
...
schemavid_t IndexPartitionSchema::GetSchemaVersionId() const { return mImpl->GetSchemaVersionId(); }

void IndexPartitionSchema::SetSchemaVersionId(schemavid_t schemaId) { mImpl->SetSchemaVersionId(schemaId); }
