...
void RegionSchema::AddSummaryConfig(const string& fieldName, summarygroupid_t summaryGroupId)
{
    mImpl->AddSummaryConfig(fieldName, summaryGroupId);
}
void RegionSchema::AddSummaryConfig(fieldid_t fieldId, summarygroupid_t summaryGroupId)
{
    mImpl->AddSummaryConfig(fieldId, summaryGroupId);
}
void RegionSchema::SetSummaryCompress(bool compress, const string& compressType, summarygroupid_t summaryGroupId)
{
