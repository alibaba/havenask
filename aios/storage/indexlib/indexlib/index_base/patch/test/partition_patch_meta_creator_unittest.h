...
private:
    ...
    void PreparePatchIndex(const file_system::DirectoryPtr& rootDir, schemavid_t schemaId, const std::string& dataStr);

    void CheckPatchMeta(const PartitionPatchMetaPtr& patchMeta, schemavid_t schemaId, const std::string& dataStr);
