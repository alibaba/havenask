...
void OptimizeMergeStrategyTest::CaseSetUp() { mRootDir = GET_TEMP_DATA_PATH(); }
...
void OptimizeMergeStrategyTest::TestCaseForSetParameter()
{
    ...
    {
        OptimizeMergeStrategy oms(mSegDir, schema);
        EXPECT_THROW(oms.SetParameter("after-merge-max-segment-count=10;after-merge-max-doc-count=10;"),
...
void OptimizeMergeStrategyTest::TestRepeatMerge()
{
    ...
    }
    {
        ...
        SegmentMergeInfos segMergeInfos = CreateSegmentMergeInfos("0:1#10,1:1#10,2:1#10,3:1#10");
        OptimizeMergeStrategy ms(mSegDir, schema);
...
SegmentMergeInfos OptimizeMergeStrategyTest::CreateSegmentMergeInfos(const string& segMergeInfosStr)
{
