...
{
public:
    AlignVersionMergeStrategy(const SegmentDirectoryPtr& segDir, const config::IndexPartitionSchemaPtr& schema);
    ~AlignVersionMergeStrategy();

    DECLARE_MERGE_STRATEGY_CREATOR(AlignVersionMergeStrategy, ALIGN_VERSION_MERGE_STRATEGY_STR);
