...
void SubDocTest::CaseSetUp()
{
    ...
    mPartMeta->AddSortDescription("sortField", indexlibv2::config::sp_asc);
    mRootDir = GET_TEMP_DATA_PATH();

    mOptions.GetOnlineConfig().buildConfig.speedUpPrimaryKeyReader = std::get<0>(GetParam());
    mOptions.GetOfflineConfig().buildConfig.speedUpPrimaryKeyReader = std::get<0>(GetParam());
    mOptions.SetEnablePackageFile(std::get<1>(GetParam()));
    mOptions.GetOnlineConfig().SetEnableRedoSpeedup(true);
    mOptions.GetOnlineConfig().SetVersionTsAlignment(1);
    util::BuildTestUtil::SetupIndexPartitionOptionsForBuildMode(/*buildMode=*/std::get<2>(GetParam()), &mOptions);
...
bool SubDocTest::CheckDocCount(const test::PartitionStateMachine& psm, size_t mainDocCount, size_t subDocCount)
{
    ...
    if (mainDocCount != mainInfo->GetTotalDocCount()) {
        IE_LOG(ERROR, "Actual Main DocCount[%lu] != Exppect[%lu]", mainInfo->GetTotalDocCount(), mainDocCount);
        return false;
    }
    if (subDocCount != subInfo->GetTotalDocCount()) {
        IE_LOG(ERROR, "Actual Sub DocCount[%lu] != Exppect[%lu]", subInfo->GetTotalDocCount(), mainDocCount);
        return false;
    }
    return true;
}
...
void SubDocTest::TestAddMainDocWithSubDoc()
{
    ...
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,pkstr=hello,main_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s2", "docid=1,subpkstr=sub2,sub_join=0;"));

    string docString2 = "cmd=add,pkstr=hello2,ts=1,subpkstr=sub3^sub4,substr1=s3^s4";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, docString2, "pk:hello2", "docid=1,pkstr=hello2,main_join=4;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s4", "docid=3,subpkstr=sub4,sub_join=1;"));

    string docStringRt = "cmd=add,pkstr=hello3,ts=2,subpkstr=sub5,substr1=s5";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docStringRt, "pk:hello3", "docid=2,pkstr=hello3,main_join=5;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, "", "subindex1:s5", "docid=4,subpkstr=sub5,sub_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, "", "__subdocid:4", "docid=4,subpkstr=sub5,sub_join=2;"));
}

void SubDocTest::TestAddMainDocOnly()
{
    string docString1 = "cmd=add,pkstr=hello1,text1=m,ts=1";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString1, "pack1:m", "docid=0,pkstr=hello1,main_join=0;"));
...
void SubDocTest::TestAddDocInRtOnly()
{
    ...
    string docString = "cmd=add,pkstr=hello,ts=0,subpkstr=sub1^sub2,substr1=s1^s2";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docString, "pk:hello", "docid=0,pkstr=hello,main_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, "", "subindex1:s2", "docid=1,subpkstr=sub2,sub_join=0;"));
    INDEXLIB_TEST_TRUE(CheckDocCount(psm, 1, 2));

    string docString2 = "cmd=add,pkstr=hello2,ts=1,subpkstr=sub3^sub4,substr1=s3^s4";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docString2, "pk:hello2", "docid=1,pkstr=hello2,main_join=4;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, "", "subindex1:s4", "docid=3,subpkstr=sub4,sub_join=1;"));
...
void SubDocTest::TestAddDupMainDoc()
{
    ...
    PartitionStateMachine psm;
    INDEXLIB_TEST_TRUE(psm.Init(mSchema, mOptions, mRootDir));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,main_join=1;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s1", "docid=0,sub_join=0;"));
    INDEXLIB_TEST_TRUE(CheckDocCount(psm, 1, 1));

    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, docString, "pk:hello", "docid=1,main_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=1,sub_join=1;"));
    INDEXLIB_TEST_TRUE(CheckDocCount(psm, 2, 2));

    string docString2 = "cmd=add,pkstr=hello,ts=1,subpkstr=sub1,substr1=s1";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docString2, "pk:hello", "docid=2,main_join=3;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, "", "subindex1:s1", "docid=2,sub_join=2;"));
...
void SubDocTest::TestAddDupMainDocWithDiffSubDoc()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pack1:m", "docid=1,main_join=3;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s",
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, docString1, "pack1:m", "docid=2,main_join=4;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s", "docid=3,subpkstr=sub4,sub_join=2;"));

    string docString2 = "cmd=add,pkstr=main,text1=m,ts=2,subpkstr=sub5,substr1=s";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docString2, "pack1:m", "docid=3,main_join=5;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s", "docid=4,subpkstr=sub5,sub_join=3;"));
}
...
void SubDocTest::TestAddDupSubDocInFull()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pack1:m",
                                     ...
                                     "docid=1,pkstr=pk2,main_join=2;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s", "docid=1,subpkstr=sub1,sub_join=1;"));
}

void SubDocTest::TestAddDupSubDocInInc()
{
    string docString = "cmd=add,pkstr=hello,ts=0,subpkstr=sub1,substr1=s1";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s1", "docid=0,sub_join=0;"));

    // inc dup with full
    string dupDocString = "cmd=add,pkstr=hello2,ts=2,subpkstr=sub1,substr1=s1";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, dupDocString, "pk:hello", "docid=0,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "pk:hello2", "docid=1,main_join=2;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=1,sub_join=1;"));
}
...
void SubDocTest::TestAddDupSubDocInRt()
{
    ...
    // dup with full
    string dupDocString = "cmd=add,pkstr=hello2,ts=2,subpkstr=sub1,substr1=s1";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, dupDocString, "pk:hello", "docid=0,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "pk:hello2", "docid=1,main_join=2;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s1", "docid=1,sub_join=1;"));
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, dupDocString1, "pk:hello3", "docid=2,main_join=3;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "pk:hello4", "docid=3,main_join=4;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s2", "docid=3,sub_join=3;"));
}
...
void SubDocTest::TestAddDupSubDocInOneMainDocInRt()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s", "docid=0,sub_long=2,sub_join=0;"));

    string docString2 = "cmd=add,pkstr=hello2,ts=0,subpkstr=ns0^ns1^ns2^ns1^ns1,"
                        "sub_long=1^2^3^4^5,substr1=ns^ns^ns^ns^ns";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString2, "pk:hello2", "docid=1,main_join=4;"));
...
{
    IndexPartitionSchemaPtr schema = SchemaMaker::MakeSchema("pkstr:string;", "pk:primarykey64:pkstr;", "", "");
    ...
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:main1", "docid=0,main_join=1;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, "", "sub_pk:sub1", "docid=0,sub_join=0;"));
}
...
void SubDocTest::TestBuildingSegmentDedup()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pack1:m", "docid=1,main_join=2"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(QUERY, "", "subindex1:s", "docid=1,sub_join=1;"));

    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, docString, "pack1:m", "docid=3,main_join=4"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(QUERY, "", "subindex1:s", "docid=3,sub_join=3;"));
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docStringRt, "pack1:m", "docid=5,main_join=6"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(QUERY, "", "subindex1:s", "docid=5,sub_join=5;"));
}
...
void SubDocTest::TestRewriteToUpdateDocWithMainFieldModified()
{
    ...
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,pkstr=hello,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "sub_pk:sub1", "docid=0,subpkstr=sub1,sub_join=0;"));
    ...
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_INC_NO_MERGE, docString2, "pk:hello", "docid=0,pkstr=hello,long1=2,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "sub_pk:sub1", "docid=0,subpkstr=sub1,sub_join=0;"));
    INDEXLIB_TEST_TRUE(CheckDocCount(mPsm, 1, 1));
}
...
void SubDocTest::TestRewriteToUpdateDocWithSubFieldModified()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,long1=1,main_join=2;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "sub_pk:sub2", "docid=1,sub_long=2,sub_join=0;"));
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, docString2, "pk:hello", "docid=0,long1=2,main_join=2"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "sub_pk:sub1", "docid=0,sub_long=1,sub_join=0;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "sub_pk:sub2", "docid=1,sub_long=4,sub_join=0;"));
}
...
void SubDocTest::TestRewriteToUpdateDocWithOnlySubFieldModified()
{
    ...
    string docString2 = "cmd=add,pkstr=hello,long1=2,ts=1,modify_fields=sub_long,"
                        "subpkstr=sub1^sub2,sub_long=3^4,sub_modify_fields=^sub_long";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, docString2, "pk:hello", "docid=0,long1=1,main_join=2"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "sub_pk:sub1", "docid=0,sub_long=1,sub_join=0;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "sub_pk:sub2", "docid=1,sub_long=4,sub_join=0;"));
}
...
void SubDocTest::TestRewriteToUpdateDocForExceptionSubModifiedField()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "sub_pk:sub1", "docid=0,sub_long=1,sub_join=0;"));
    string docString2 = "cmd=add,pkstr=hello,long1=2,modify_fields=long1#sub_long,"
                        "subpkstr=sub1,sub_long=2";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, docString2, "pk:hello", "docid=1,long1=2,main_join=2"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "sub_pk:sub1", "docid=1,sub_long=2,sub_join=1;"));
}
...
void SubDocTest::TestUpdateMainDocOnly()
{
    ...
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,pkstr=hello,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=0,subpkstr=sub1,sub_long=1,sub_join=0;"));

    string docString1 = "cmd=update_field,pkstr=hello,long1=2,ts=1";
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_INC_NO_MERGE, docString1, "pk:hello", "docid=0,pkstr=hello,long1=2,main_join=1;"));
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=0,subpkstr=sub1,sub_long=1,sub_join=0;"));

    string docString2 = "cmd=update_field,pkstr=hello,long1=3,ts=2";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docString2, "pk:hello", "docid=0,pkstr=hello,long1=3,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s1", "docid=0,subpkstr=sub1,sub_long=1,sub_join=0;"));
}
...
void SubDocTest::TestUpdateSubDocOnly()
{
    ...
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_INC_NO_MERGE, docString1, "pk:hello", "docid=0,pkstr=hello,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=0,subpkstr=sub1,sub_join=0,sub_long=2;"));

    string docString2 = "cmd=update_field,pkstr=hello,ts=2,subpkstr=sub1,sub_long=3";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docString2, "pk:hello", "docid=0,pkstr=hello,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s1", "docid=0,subpkstr=sub1,sub_join=0,sub_long=3;"));
}
...
void SubDocTest::TestUpdateMainDocWithSubDocInOneSegment()
{
    ...
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,pkstr=hello,long1=2,main_join=1;"));
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s1", "docid=0,subpkstr=sub1,sub_join=0,sub_long=2;"));
}
...
void SubDocTest::TestDeleteMainDocOnly()
{
    ...
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "subindex1:s1", "docid=0,subpkstr=sub1,sub_join=0;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s2", "docid=1,subpkstr=sub2,sub_join=1;"));
...
void SubDocTest::TestDeleteSubDocOnly()
{
    ...
    INDEXLIB_TEST_TRUE(psm.Init(mSchema, mOptions, mRootDir));
    INDEXLIB_TEST_TRUE(
        psm.Transfer(BUILD_FULL_NO_MERGE, docString, "subindex1:s1", "docid=0,subpkstr=sub1,sub_join=0;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s2", "docid=1,subpkstr=sub2,sub_join=1;"));

    string docString2 = "cmd=delete_sub,pkstr=hello,ts=1,subpkstr=sub1";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, docString2, "pk:hello", "docid=0,main_join=1"));
    ...
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docString3, "pk:hello2", "docid=1,main_join=2"));
...
void SubDocTest::TestObsoleteRtDoc()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, docString, "pack1:m", "docid=0,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_FULL_NO_MERGE, "", "subindex1:s", "docid=0,sub_long=1,subpkstr=sub1,sub_join=0;"));

    string docString2 = "cmd=add,pkstr=main,text1=m,ts=2,subpkstr=sub5,substr1=s";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docString2, "pack1:m", "docid=0,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s", "docid=0,sub_long=1,subpkstr=sub1,sub_join=0;"));

    string docString3 = "cmd=delete,pkstr=main,ts=2";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docString3, "pack1:m", "docid=0,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s", "docid=0,sub_long=1,subpkstr=sub1,sub_join=0;"));

    string docString4 = "cmd=delete_sub,pkstr=main,ts=2,subpkstr=sub1";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docString4, "pack1:m", "docid=0,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s", "docid=0,sub_long=1,subpkstr=sub1,sub_join=0;"));

    string docString5 = "cmd=update_field,long1=2,pkstr=main,ts=2,subpkstr=sub1";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docString5, "pack1:m", "docid=0,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s", "docid=0,sub_long=1,subpkstr=sub1,sub_join=0;"));

    string docString6 = "cmd=update_field,pkstr=main,ts=2,subpkstr=sub1,sub_long=2";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, docString6, "pack1:m", "docid=0,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT, "", "subindex1:s", "docid=0,sub_long=1,subpkstr=sub1,sub_join=0;"));
    // reopen
    string docStringOther = "cmd=add,pkstr=other,text1=o,ts=10,subpkstr=subOther,substr1=so";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, docStringOther, "pack1:m", "docid=0,long1=1,main_join=1;"));
    INDEXLIB_TEST_TRUE(
        mPsm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s", "docid=0,sub_long=1,subpkstr=sub1,sub_join=0;"));
}
...
void SubDocTest::TestNeedDumpByMaxDocCount()
{
    ...
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, docString, "pack1:m", "docid=0;docid=1;docid=2"));
...
void SubDocTest::TestNeedDumpByMemorUse()
{
    ...
    string docString = "cmd=add,pkstr=pk1,text1=m,subpkstr=sub1,substr1=" + substring1 + ";";
    docString += "cmd=add,pkstr=pk2,text1=m,subpkstr=sub2,substr1=s;";

    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, docString, "pack1:m", "docid=0;docid=1"));
...
void SubDocTest::TestReOpenWithAdd()
{
    ...
    INDEXLIB_TEST_TRUE(psm.Init(mSchema, mOptions, mRootDir));
    string docString = "cmd=add,pkstr=hello,long1=1,ts=0,subpkstr=sub1,substr1=s1,sub_long=1";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docString, "pk:hello", "docid=0,long1=1,main_join=1;"));
    string docString2 = "cmd=add,pkstr=hello,long1=3,ts=1,subpkstr=sub1,substr1=s1,sub_long=3";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docString2, "pk:hello", "docid=1,long1=3,main_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, docString, "pk:hello", "docid=2,long1=3,main_join=3;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=2,sub_long=3,sub_join=2;"));
}
...
void SubDocTest::TestReOpenWithUpdate()
{
    ...
    INDEXLIB_TEST_TRUE(psm.Init(mSchema, mOptions, mRootDir));
    INDEXLIB_TEST_TRUE(
        psm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,pkstr=hello,long1=1,main_join=1;"));

    string docString1 = "cmd=update_field,pkstr=hello,long1=2,ts=3,subpkstr=sub1,sub_long=2";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docString1, "pk:hello", "docid=0,pkstr=hello,long1=2,main_join=1;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, "", "subindex1:s1", "docid=0,subpkstr=sub1,sub_join=0,sub_long=2;"));

    string docString2 = "cmd=update_field,pkstr=hello,long1=3,ts=2,subpkstr=sub1,sub_long=3";
    INDEXLIB_TEST_TRUE(
        psm.Transfer(BUILD_INC_NO_MERGE, docString2, "pk:hello", "docid=0,pkstr=hello,long1=2,main_join=1;"));
    INDEXLIB_TEST_TRUE(
        psm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=0,subpkstr=sub1,sub_join=0,sub_long=2;"));
}
...
void SubDocTest::TestReOpenWithDeleteSub()
{
    ...
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, docString2, "pk:hello", "docid=0,main_join=1"));
...
void SubDocTest::TestForceReOpenWithAdd()
{
    ...
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, docString, "pk:hello", "docid=2,long1=3,main_join=3;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=2,sub_long=3,sub_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE_FORCE_REOPEN, "", "pk:hello", "docid=2,long1=3,main_join=3;"));
    INDEXLIB_TEST_TRUE(
        psm.Transfer(BUILD_INC_NO_MERGE_FORCE_REOPEN, "", "subindex1:s1", "docid=2,sub_long=3,sub_join=2;"));
}
...
void SubDocTest::TestMerge()
{
    ...
    PartitionStateMachine psm;
    INDEXLIB_TEST_TRUE(psm.Init(mSchema, mOptions, mRootDir));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL, docString, "pk:hello", "docid=0,pkstr=hello,main_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL, "", "subindex1:s2", "docid=1,subpkstr=sub2,sub_join=0;"));

    string docString2 = "cmd=add,pkstr=hello2,ts=1,subpkstr=sub3^sub4,substr1=s3^s4";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC, docString2, "pk:hello", "docid=0,pkstr=hello,main_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC, "", "pk:hello2", "docid=1,pkstr=hello2,main_join=4;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC, "", "subindex1:s4", "docid=3,subpkstr=sub4,sub_join=1;"));
}
...
void SubDocTest::DoTestMergeForJoinDocIdWithEmptySubDocAndDupDoc(bool multiTargetSegment)
{
    ...
    IndexPartitionOptions options =
        util::BuildTestUtil::GetIndexPartitionOptionsForBuildMode(/*buildMode=*/std::get<2>(GetParam()));
    options.GetOfflineConfig().buildConfig.maxDocCount = 2;
    if (multiTargetSegment) {
        std::string mergeConfigStr = "{\"class_name\":\"default\",\"parameters\":{\"split_num\":\"3\"}}";
...
void SubDocTest::TestMergeWithEmptySubSegment()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, incDoc, "pk:hello6", "docid=2;"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "sub_pk:sub2", "docid=1;"));
...
void SubDocTest::TestMergeWithEmptyMainAndSubSegment()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL, docString, "pk:hello", "docid=0,long1=1;"));

    string incDoc = "cmd=update_field,pkstr=hello,long1=2;";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC, incDoc, "pk:hello", "docid=0,long1=2;"));

    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, "", "subindex1:s1", "docid=0;docid=1;"));
    string delDoc = "cmd=delete_sub,pkstr=hello,subpkstr=sub2;";
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC, delDoc, "subindex1:s1", "docid=0;"));
}
...
void SubDocTest::TestGetDocIdAfterUpdateDocument() { TestGetDocIdWithCommand("update_field"); }
...
void SubDocTest::TestBuildEmptySegmentInSubSegment()
{
    ...
    file_system::DirectoryPtr segmentDirectory = GET_PARTITION_DIRECTORY()->GetDirectory("segment_0_level_0", true);
    std::vector<FileInfo> fileInfos;
    segmentDirectory->ListPhysicalFile("", fileInfos, true);
    std::vector<string> fileList;
    for (const FileInfo& fileInfo : fileInfos) {
        fileList.push_back(fileInfo.filePath);
    }
    sort(fileList.begin(), fileList.end());
    fileList.erase(unique(fileList.begin(), fileList.end()), fileList.end());
    ...
    EXPECT_THAT(expectFileList, testing::UnorderedElementsAreArray(fileList));
}
...
void SubDocTest::InnerTestBuildAndMergeWithPackageFile(bool optimizeMerge)
{
    ...
    if (!optimizeMerge) {
        ...
        options.GetMergeConfig().mergeStrategyParameter.SetLegacyString("merge_segments=2,8");
    }
...
void SubDocTest::DoTestOptimizedReopen(const string& fullDocSeq, const string& rtDocSeq, const string& incDocSeq,
                                       bool isIncMerge)
{
    vector<string> docs;
...
string SubDocTest::GetDoc(const vector<string>& docs, const string& docSeq)
{
...
{
    FileList fileList;
    ASSERT_EQ(FSEC_OK, FslibWrapper::ListDirRecursive(segmentDirPath, fileList).Code());
    FileList expectFileList {"deploy_index", "counter", "package_file.__data__0", "package_file.__meta__",
                             "segment_info", "segment_file_list", "sub_segment/",
                             //"sub_segment/package_file.__data__0",
                             //"sub_segment/package_file.__meta__",
                             "sub_segment/segment_info", "sub_segment/counter"};
    sort(fileList.begin(), fileList.end());
...
bool SubDocTest::CheckAccessCounter(const string& name, int expect)
{
    ...
    if (name == "pack1" || name == "subindex1" || name == "pk" || name == "sub_pk") {
...
void SubDocTest::TestAccessCounters()
{
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_FULL_NO_MERGE, fullDoc, "pack1:m", "docid=0,long1=1"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(QUERY, "", "subindex1:s", "docid=0,sub_long=11;"));
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_INC_NO_MERGE, incDoc, "pack1:m", "docid=1,long1=1"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(QUERY, "", "subindex1:s", "docid=1,sub_long=11;"));
    ...
    INDEXLIB_TEST_TRUE(mPsm.Transfer(BUILD_RT_SEGMENT, rtDoc, "pack1:m", "docid=2,long1=1"));
    INDEXLIB_TEST_TRUE(mPsm.Transfer(QUERY, "", "subindex1:s", "docid=2,sub_long=11;"));
...
{
    SlowDumpSegmentContainerPtr slowDumpContainer(new SlowDumpSegmentContainer(3600u * 24 * 30 * 1000, false, true));
    PartitionStateMachine psm(false, IndexPartitionResource(), slowDumpContainer);
    ...
    string docString = "cmd=add,pkstr=hello,ts=0,subpkstr=sub1^sub2,substr1=s1^s2;";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, docString, "pk:hello", "docid=0,pkstr=hello,main_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "subindex1:s2", "docid=1,subpkstr=sub2,sub_join=0;"));

    // inc build
    string docString2 = "cmd=add,pkstr=hello2,ts=1,subpkstr=sub3^sub4,substr1=s3^s4;";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, docString2, "pk:hello2", "docid=1,pkstr=hello2,main_join=4;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "subindex1:s4", "docid=3,subpkstr=sub4,sub_join=1;"));

    // dumping rt segment1
    slowDumpContainer->EnableSlowSleep();
    string docStringRt1 = "cmd=add,pkstr=hello3,ts=2,subpkstr=sub5,substr1=s5;";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT_SEGMENT, docStringRt1, "pk:hello3", "docid=2,pkstr=hello3,main_join=5;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "subindex1:s5", "docid=4,subpkstr=sub5,sub_join=2;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "__subdocid:4", "docid=4,subpkstr=sub5,sub_join=2;"));

    // dumping rt segment2
    string docStringRt2 = "cmd=add,pkstr=hello4,ts=3,subpkstr=sub6^sub7,substr1=s6^s7;";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT_SEGMENT, docStringRt2, "pk:hello4", "docid=3,pkstr=hello4,main_join=7;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "subindex1:s7", "docid=6,subpkstr=sub7,sub_join=3;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "__subdocid:5", "docid=5,subpkstr=sub6,sub_join=3;"));

    // building segment
    string buildingRtDoc = "cmd=add,pkstr=hello5,ts=4,subpkstr=sub8,substr1=s8;";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_RT, buildingRtDoc, "pk:hello5", "docid=4,pkstr=hello5,main_join=8;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "subindex1:s8", "docid=7,subpkstr=sub8,sub_join=4;"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "__subdocid:7", "docid=7,subpkstr=sub8,sub_join=4;"));
    ...
    string newInc = docStringRt1 + "cmd=add,pkstr=new_hello,ts=3,subpkstr=sub_new,substr1=s_new;";
    INDEXLIB_TEST_TRUE(psm.Transfer(BUILD_INC_NO_MERGE, newInc, "pk:new_hello", "docid=3,pkstr=new_hello,main_join=6"));
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "pk:hello3", ""));          // del main, query main
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "subindex1:s5", ""));       // del main, query sub
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "subindex1:s6", ""));       // del sub, query sub
    INDEXLIB_TEST_TRUE(psm.Transfer(QUERY, "", "subindex1:s7",             // del sub,query valid sub in same main
...
{
    bool enableTag = std::get<0>(GetParam());
    bool zeroCheckpoint = std::get<1>(GetParam());
    bool debug = true;
    ...
    if (zeroCheckpoint) {
        mOptions.GetMergeConfig().SetCheckpointInterval(0);
    }
    ...
    string docString0 = "cmd=add,pkstr=mpk1,long1=11,ts=0,subpkstr=spk1^spk2,substr1=ss1^ss2";
    ASSERT_TRUE(psm.Transfer(BUILD_FULL, docString0, "pk:mpk1", "docid=0,pkstr=mpk1,long1=11,main_join=2;"));
    ASSERT_TRUE(psm.Transfer(BUILD_FULL, "", "subindex1:ss2", "docid=1,subpkstr=spk2,sub_join=0;"));

    // output: BUILD[2] = [1,2,3], MERGE[3] = [4]
    MergeConfig mergeConfig = mOptions.GetMergeConfig();
    mergeConfig.mergeStrategyStr = "balance_tree";
    mergeConfig.mergeStrategyParameter.SetLegacyString("base-doc-count=1;max-doc-count=2;conflict-segment-number=3;");
    psm.SetMergeConfig(mergeConfig);
    string docString1 = "cmd=add,pkstr=mpk2,long1=12,ts=1,subpkstr=spk3^spk4,substr1=ss3^ss4,sub_long=30^40;"
                        "cmd=add,pkstr=mpk3,long1=13,ts=1";
    ASSERT_TRUE(psm.Transfer(BUILD_INC, docString1, "pk:mpk1", "docid=0,pkstr=mpk1,long1=11,main_join=2;"));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:mpk2", "docid=1,pkstr=mpk2,long1=12,main_join=4;"));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:mpk3", "docid=2,pkstr=mpk3,long1=13,main_join=4;"));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "subindex1:ss4", "docid=3,subpkstr=spk4,sub_join=1;"));
    ...
    psm.SetMergeConfig(mergeConfig);
    string docString2 = "cmd=update_field,pkstr=mpk2,long1=121,ts=2,subpkstr=spk4,sub_long=401;"
                        "cmd=delete,pkstr=mpk3,ts=2;";
    ASSERT_TRUE(psm.Transfer(BUILD_INC, docString2, "pk:mpk1", "docid=0,pkstr=mpk1,long1=11,main_join=2;"));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:mpk2", "docid=1,pkstr=mpk2,long1=121,main_join=4;"));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:mpk3", ""));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "subindex1:ss4", "docid=3,subpkstr=spk4,sub_long=401,sub_join=1;"));
    ...
    auto seg6Dir = GET_CHECK_DIRECTORY()->GetDirectory("segment_6_level_0", false);
    ASSERT_NE(seg6Dir, nullptr);
    ASSERT_EQ(packageMeta6.Load(segment6 + "/package_file.__meta__"), FSEC_OK);
    ...
    auto subDir = seg6Dir->GetDirectory("sub_segment", false);
    ASSERT_NE(subDir, nullptr);
    ASSERT_EQ(subPackageMeta6.Load(PathUtil::JoinPath(segment6, "sub_segment/package_file.__meta__")), FSEC_OK);
    ...
    ASSERT_TRUE(SegmentFileListWrapper::Load(seg6Dir, indexFileList6));
    const auto& indexFiles = indexFileList6.deployFileMetas;

    map<string, size_t> allIndxFiles;
    for (size_t i = 0; i < indexFiles.size(); ++i) {
        if (debug) {
            cout << "##[" << getpid() << "]IFL: " << indexFiles[i].filePath << ":" << indexFiles[i].fileLength << endl;
        }
    ...
    for (size_t i = 0; i < dataFileNames.size(); ++i) {
        if (debug) {
            cout << "##[" << getpid() << "]MPFM: " << dataFileNames[i] << ":" << dataFileTags[i] << ":"
                 << dataFileLengths[i] << endl;
        }
        ...
        ASSERT_EQ(allIndxFiles[dataFileNames[i]], dataFileLengths[i]) << "file [" << dataFileNames[i] << "]";
    ...
    for (size_t i = 0; i < subDataFileNames.size(); ++i) {
        if (debug) {
            cout << "##[" << getpid() << "]SPFM: " << subDataFileNames[i] << ":" << subDataFileTags[i] << ":"
                 << subDataFileLengths[i] << endl;
        }
