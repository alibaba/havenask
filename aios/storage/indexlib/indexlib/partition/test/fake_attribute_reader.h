...
public:
    void AddAttributeSegmentReader(const AttributeSegmentReaderPtr& attrSegReader)
    {
    ...
    bool GetSortedDocIdRange(const table::DimensionDescription::Range& range, const DocIdRange& rangeLimit,
