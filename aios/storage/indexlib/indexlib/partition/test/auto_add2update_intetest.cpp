...
void AutoAdd2updateTest::TestSimpleProcess()
{
    ...
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:pk0", "attr1=11,attr2=12,attr3=13,attr4=hello kitty,attr5=50 60,attr6=hi"));
}
...
void AutoAdd2updateTest::TestIncCoverRt()
{
    ...
    ASSERT_TRUE(psm.Init(schema, options, GET_TEMP_DATA_PATH()));
    ASSERT_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, fullDocs, "", ""));
    ASSERT_TRUE(psm.Transfer(BUILD_RT, rtDocs, "pk:pk0", "attr1=2,attr2=3,attr3=4,attr4=hello,attr5=7 8,attr6=hi"));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:pk1", "attr1=22,attr2=22,attr3=23,attr4=kitty hi,attr5=50 60,attr6=he"));
    string incDocs =
        "cmd=add,string1=pk0,attr1=21,attr2=31,attr3=41,attr4=hello 1,attr5=71 81,attr6=he,ts=2;"
        "cmd=add,string1=pk1,attr1=11,attr2=12,attr3=13,attr4=hello kitty,attr5=50 60,attr6=hi,ts=2;##stopTs=3;";
    ASSERT_TRUE(
        psm.Transfer(BUILD_INC, incDocs, "pk:pk0", "attr1=21,attr2=31,attr3=41,attr4=hello 1,attr5=71 81,attr6=he"));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:pk1", "attr1=22,attr2=22,attr3=23,attr4=kitty hi,attr5=50 60,attr6=he"));
}
...
void AutoAdd2updateTest::TestBug_22229643()
{
    ...
    ASSERT_TRUE(psm.Init(schema, options, GET_TEMP_DATA_PATH()));
    ASSERT_TRUE(psm.Transfer(BUILD_FULL_NO_MERGE, fullDocs, "", ""));
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:pk0", "attr1=1,attr2=2,attr3=3,attr4=hello world,attr5=5 6,attr6=hello"));
    ...
    ASSERT_TRUE(psm.Transfer(QUERY, "", "pk:pk0", "attr1=11,attr2=12,attr3=13,attr4=,attr5=50 60,attr6=hi"));
}
