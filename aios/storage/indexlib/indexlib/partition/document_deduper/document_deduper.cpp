...
DocumentDeduper::DocumentDeduper(const IndexPartitionSchemaPtr& schema) : mSchema(schema) {}

DocumentDeduper::~DocumentDeduper() {}

const SingleFieldIndexConfigPtr&
DocumentDeduper::GetPrimaryKeyIndexConfig(const IndexPartitionSchemaPtr& partitionSchema)
{
