...
static __inline__ void __DEFAULT_FN_ATTRS __llwpcb(void* __addr) { __builtin_ia32_llwpcb(__addr); }
...
static __inline__ void* __DEFAULT_FN_ATTRS __slwpcb(void) { return __builtin_ia32_slwpcb(); }
...
#define __lwpins32(DATA2, DATA1, FLAGS)                                                                                \
    (__builtin_ia32_lwpins32((unsigned int)(DATA2), (unsigned int)(DATA1), (unsigned int)(FLAGS)))
...
#define __lwpval32(DATA2, DATA1, FLAGS)                                                                                \
    (__builtin_ia32_lwpval32((unsigned int)(DATA2), (unsigned int)(DATA1), (unsigned int)(FLAGS)))
...
#define __lwpins64(DATA2, DATA1, FLAGS)                                                                                \
    (__builtin_ia32_lwpins64((unsigned long long)(DATA2), (unsigned int)(DATA1), (unsigned int)(FLAGS)))
...
#define __lwpval64(DATA2, DATA1, FLAGS)                                                                                \
    (__builtin_ia32_lwpval64((unsigned long long)(DATA2), (unsigned int)(DATA1), (unsigned int)(FLAGS)))
