...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AES__) || defined(__PCLMUL__))
#include <wmmintrin.h>
#endif
...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VL__) && defined(__AVX512VPOPCNTDQ__))
...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VL__) && defined(__AVX512VNNI__))
...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VL__) && defined(__AVX512BITALG__))
...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VL__) && defined(__AVX512CD__))
#include <avx512vlcdintrin.h>
#endif

#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VL__) && defined(__AVX512DQ__))
...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512IFMA__) && defined(__AVX512VL__))
...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VBMI__) && defined(__AVX512VL__))
...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VBMI2__) && defined(__AVX512VL__))
...
#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VL__) && defined(__AVX512BF16__))
...
#if !defined(_MSC_VER) || __has_feature(modules) || defined(__MOVDIRI__) || defined(__MOVDIR64B__)
...
#if !defined(_MSC_VER) || __has_feature(modules) || defined(__AVX512VP2INTERSECT__)
#include <avx512vp2intersectintrin.h>
#endif

#if !defined(_MSC_VER) || __has_feature(modules) || (defined(__AVX512VL__) && defined(__AVX512VP2INTERSECT__))
...
{
    __asm__ __volatile__(".byte 0xf2 ; lock ; xchg %0, %1" : "+r"(_Value), "+m"(*_Target)::"memory");
    return _Value;
}
static __inline__ long __DEFAULT_FN_ATTRS _InterlockedExchange_HLERelease(long volatile* _Target, long _Value)
{
    __asm__ __volatile__(".byte 0xf3 ; lock ; xchg %0, %1" : "+r"(_Value), "+m"(*_Target)::"memory");
    return _Value;
}
#endif
#if defined(__x86_64__)
static __inline__ __int64 __DEFAULT_FN_ATTRS _InterlockedExchange64_HLEAcquire(__int64 volatile* _Target,
                                                                               __int64 _Value)
{
    __asm__ __volatile__(".byte 0xf2 ; lock ; xchg %0, %1" : "+r"(_Value), "+m"(*_Target)::"memory");
    return _Value;
}
static __inline__ __int64 __DEFAULT_FN_ATTRS _InterlockedExchange64_HLERelease(__int64 volatile* _Target,
                                                                               __int64 _Value)
{
    __asm__ __volatile__(".byte 0xf3 ; lock ; xchg %0, %1" : "+r"(_Value), "+m"(*_Target)::"memory");
    return _Value;
...
\*----------------------------------------------------------------------------*/
#if defined(__i386__) || defined(__x86_64__)
static __inline__ long __DEFAULT_FN_ATTRS _InterlockedCompareExchange_HLEAcquire(long volatile* _Destination,
...
static __inline__ long __DEFAULT_FN_ATTRS _InterlockedCompareExchange_HLERelease(long volatile* _Destination,
                                                                                 long _Exchange, long _Comparand)
{
...
#endif
#if defined(__x86_64__)
static __inline__ __int64 __DEFAULT_FN_ATTRS _InterlockedCompareExchange64_HLEAcquire(__int64 volatile* _Destination,
                                                                                      __int64 _Exchange,
                                                                                      __int64 _Comparand)
{
    __asm__ __volatile__(".byte 0xf2 ; lock ; cmpxchg %2, %1"
...
static __inline__ __int64 __DEFAULT_FN_ATTRS _InterlockedCompareExchange64_HLERelease(__int64 volatile* _Destination,
                                                                                      __int64 _Exchange,
                                                                                      __int64 _Comparand)
{
    __asm__ __volatile__(".byte 0xf3 ; lock ; cmpxchg %2, %1"
