...
#define __DEFAULT_FN_ATTRS                                                                                             \
    __attribute__((__always_inline__, __nodebug__, __target__("sse4.1"), __min_vector_width__(128)))
...
{
    return (__m128d)__builtin_ia32_blendvpd((__v2df)__V1, (__v2df)__V2, (__v2df)__M);
}
...
{
    return (__m128i)__builtin_ia32_pblendvb128((__v16qi)__V1, (__v16qi)__V2, (__v16qi)__M);
}
...
#define _mm_blend_epi16(V1, V2, M)                                                                                     \
    (__m128i) __builtin_ia32_pblendw128((__v8hi)(__m128i)(V1), (__v8hi)(__m128i)(V2), (int)(M))
...
static __inline__ __m128i __DEFAULT_FN_ATTRS _mm_cvtepi8_epi16(__m128i __V)
{
    ...
    return (__m128i) __builtin_convertvector(
        __builtin_shufflevector((__v16qs)__V, (__v16qs)__V, 0, 1, 2, 3, 4, 5, 6, 7), __v8hi);
}
...
{
    return (__m128i) __builtin_convertvector(
        __builtin_shufflevector((__v16qu)__V, (__v16qu)__V, 0, 1, 2, 3, 4, 5, 6, 7), __v8hi);
}
...
#define _mm_cmpistrm(A, B, M)                                                                                          \
    (__m128i) __builtin_ia32_pcmpistrm128((__v16qi)(__m128i)(A), (__v16qi)(__m128i)(B), (int)(M))
...
#define _mm_cmpestrm(A, LA, B, LB, M)                                                                                  \
    (__m128i) __builtin_ia32_pcmpestrm128((__v16qi)(__m128i)(A), (int)(LA), (__v16qi)(__m128i)(B), (int)(LB), (int)(M))
...
#define _mm_cmpestri(A, LA, B, LB, M)                                                                                  \
    (int)__builtin_ia32_pcmpestri128((__v16qi)(__m128i)(A), (int)(LA), (__v16qi)(__m128i)(B), (int)(LB), (int)(M))
...
#define _mm_cmpestra(A, LA, B, LB, M)                                                                                  \
    (int)__builtin_ia32_pcmpestria128((__v16qi)(__m128i)(A), (int)(LA), (__v16qi)(__m128i)(B), (int)(LB), (int)(M))
...
#define _mm_cmpestrc(A, LA, B, LB, M)                                                                                  \
    (int)__builtin_ia32_pcmpestric128((__v16qi)(__m128i)(A), (int)(LA), (__v16qi)(__m128i)(B), (int)(LB), (int)(M))
...
#define _mm_cmpestro(A, LA, B, LB, M)                                                                                  \
    (int)__builtin_ia32_pcmpestrio128((__v16qi)(__m128i)(A), (int)(LA), (__v16qi)(__m128i)(B), (int)(LB), (int)(M))
...
#define _mm_cmpestrs(A, LA, B, LB, M)                                                                                  \
    (int)__builtin_ia32_pcmpestris128((__v16qi)(__m128i)(A), (int)(LA), (__v16qi)(__m128i)(B), (int)(LB), (int)(M))
...
#define _mm_cmpestrz(A, LA, B, LB, M)                                                                                  \
    (int)__builtin_ia32_pcmpestriz128((__v16qi)(__m128i)(A), (int)(LA), (__v16qi)(__m128i)(B), (int)(LB), (int)(M))
...
/// \returns The result of adding operand \a __C to the CRC-32C checksum of
///    operand \a __D.
static __inline__ unsigned long long __DEFAULT_FN_ATTRS _mm_crc32_u64(unsigned long long __C, unsigned long long __D)
{
