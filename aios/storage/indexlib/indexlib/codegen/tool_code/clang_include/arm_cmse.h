...
static cmse_address_info_t __attribute__((__always_inline__, __nodebug__)) cmse_TT(void* __p)
{
    cmse_address_info_t __u;
    __u.value = __builtin_arm_cmse_TT(__p);
    return __u;
}
static cmse_address_info_t __attribute__((__always_inline__, __nodebug__)) cmse_TTT(void* __p)
{
    cmse_address_info_t __u;
...
#if __ARM_CMSE_SECURE_MODE
static cmse_address_info_t __attribute__((__always_inline__, __nodebug__)) cmse_TTA(void* __p)
{
    cmse_address_info_t __u;
    __u.value = __builtin_arm_cmse_TTA(__p);
    return __u;
}
static cmse_address_info_t __attribute__((__always_inline__, __nodebug__)) cmse_TTAT(void* __p)
{
    cmse_address_info_t __u;
...
static void* __attribute__((__always_inline__)) cmse_check_address_range(void* __pb, size_t __s, int __flags)
{
...
#define cmse_nsfptr_create(p) __builtin_bit_cast(__typeof__(p), (__builtin_bit_cast(uintptr_t, p) & ~(uintptr_t)1))
