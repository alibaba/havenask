...
public:
    ...
    const std::string& getSuffix() const override { return _suffix; }

private:
    std::string _suffix;
};

NamedFactoryModuleImpl::NamedFactoryModuleImpl(const std::string& suffix) { _suffix = suffix; }

NamedFactoryModuleImpl::~NamedFactoryModuleImpl() {}

extern "C" ModuleFactory* createFactory() { return new NamedFactoryModuleImpl("Normal"); }
...
extern "C" ModuleFactory* createFactory_TestSuffix() { return new NamedFactoryModuleImpl("TestSuffix"); }

extern "C" void destroyFactory_TestSuffix(ModuleFactory* factory)
{
    NamedFactoryModuleImpl* f = dynamic_cast<NamedFactoryModuleImpl*>(factory);
...
extern "C" ModuleFactory* createFactory_OtherTest() { return new NamedFactoryModuleImpl("TestSuffix2"); }

extern "C" void destroyFactory_OtherTest(ModuleFactory* factory)
{
    NamedFactoryModuleImpl* f = dynamic_cast<NamedFactoryModuleImpl*>(factory);
