...
template <>
inline FieldType TypeInfo<uint32_t>::GetFieldType()
{
    return ft_uint32;
}
...
//////////////////////////// Field Type ///////////////////////
template <>
inline FieldType TypeInfo<int8_t>::GetFieldType()
{
    return ft_int8;
}

template <>
inline FieldType TypeInfo<uint8_t>::GetFieldType()
{
    return ft_uint8;
}

template <>
inline FieldType TypeInfo<int16_t>::GetFieldType()
{
    return ft_int16;
}

template <>
inline FieldType TypeInfo<uint16_t>::GetFieldType()
{
    return ft_uint16;
}
...
template <>
inline FieldType TypeInfo<int64_t>::GetFieldType()
{
    return ft_long;
}

template <>
inline FieldType TypeInfo<uint64_t>::GetFieldType()
{
    return ft_uint64;
}

template <>
inline FieldType TypeInfo<autil::uint128_t>::GetFieldType()
{
    return ft_hash_128;
}

template <>
inline FieldType TypeInfo<float>::GetFieldType()
{
    return ft_float;
}

template <>
inline FieldType TypeInfo<double>::GetFieldType()
{
    return ft_double;
}

template <>
inline FieldType TypeInfo<autil::MultiChar>::GetFieldType()
{
    return ft_string;
}

template <>
inline FieldType TypeInfo<char>::GetFieldType()
{
    return ft_string;
}
...
template <>
inline AttrType TypeInfo<char>::GetAttrType()
{
    return AT_STRING;
}
