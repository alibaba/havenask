...
public:
    ...
    void TestCaseNormal() { InnerTestCase(5, "1;2;4;3;0", "0;0;1;1;0"); }
    ...
    void TestCaseForSizeSmallerThanDocCount() { InnerTestCase(2, "1;0", "0;0"); }

    void TestCaseForSizeEqualDocCount() { InnerTestCase(4, "2;1;0;3", "1;0;0;1"); }
    ...
    void TestCaseForStoreAndLoad()
    {
        ...
        bucketMap1->Store(GET_PARTITION_DIRECTORY(), "bucket_map_file");
        BucketMapPtr bucketMap2(new BucketMap);
        bucketMap2->Load(GET_PARTITION_DIRECTORY(), "bucket_map_file");
