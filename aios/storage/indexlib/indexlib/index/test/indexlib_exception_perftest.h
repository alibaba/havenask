...
private:
    void InnerTestBuild(size_t normalIOCount, bool asyncDump, bool asyncIO, bool asyncMerge);
...
private:
    enum class IOExceptionType : int { NO_EXCEPTION = 0, LOOKUP = 1, SEEK = 2 };
...
// INDEXLIB_UNIT_TEST_CASE(IndexlibExceptionPerfTest,
// TestCaseForCreateBucketMapsExceptionAndRecover);
