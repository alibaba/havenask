 ...
 */
#ifndef __INDEXLIB_VAR_LEN_DATA_PARAM_H
#define __INDEXLIB_VAR_LEN_DATA_PARAM_H
...
struct VarLenDataParam {
    ...
    uint64_t offsetThreshold = VAR_NUM_ATTRIBUTE_OFFSET_THRESHOLD; /* threshold for enableAdaptiveOffset = true */
    ...
    util::KeyValueMap dataCompressorParams;   /* data compressor parameter */
    ...
    void SyncCompressParam(file_system::WriterOption& option) const
    {
...
#endif //__INDEXLIB_VAR_LEN_DATA_PARAM_H
