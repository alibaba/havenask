...
Indexer* DemoIndexModuleFactory::createIndexer(const util::KeyValueMap& parameters)
{
    return new DemoIndexer(parameters);
}

IndexReducer* DemoIndexModuleFactory::createIndexReducer(const util::KeyValueMap& parameters)
{
    return new DemoIndexReducer(parameters);
}

IndexSegmentRetriever* DemoIndexModuleFactory::createIndexSegmentRetriever(const util::KeyValueMap& parameters)
{
