...
ExpackPostingMaker::MergeExpackPostingLists(vector<ExpackPostingMaker::ExpackPostingList>& expackPostLists)
{
    ExpackPostingList mergedList;
    for (vector<ExpackPostingList>::const_iterator it = expackPostLists.begin(); it != expackPostLists.end(); ++it) {
...
ExpackPostingMaker::ExpackPostingList
ExpackPostingMaker::SortByWeightMergePostingLists(vector<ExpackPostingMaker::ExpackPostingList>& postLists,
