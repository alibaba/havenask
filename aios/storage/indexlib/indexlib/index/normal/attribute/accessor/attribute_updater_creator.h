...
public:
    ...
    virtual AttributeUpdater* Create(util::BuildResourceMetrics* buildResourceMetrics, segmentid_t segId,
                                     const config::AttributeConfigPtr& attrConfig) const = 0;
};

typedef std::shared_ptr<AttributeUpdaterCreator> AttributeUpdaterCreatorPtr;
