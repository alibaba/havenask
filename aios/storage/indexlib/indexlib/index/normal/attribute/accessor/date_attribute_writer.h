 ...
 */
#ifndef __INDEXLIB_DATE_ATTRIBUTE_WRITER_H
#define __INDEXLIB_DATE_ATTRIBUTE_WRITER_H
...
{
public:
    DateAttributeWriter(const config::AttributeConfigPtr& attrConfig) : SingleValueAttributeWriter(attrConfig) {}

    ~DateAttributeWriter() {}

    DECLARE_ATTRIBUTE_WRITER_IDENTIFIER(date);
...
DEFINE_SHARED_PTR(DateAttributeWriter);
}} // namespace indexlib::index

#endif //__INDEXLIB_DATE_ATTRIBUTE_WRITER_H
