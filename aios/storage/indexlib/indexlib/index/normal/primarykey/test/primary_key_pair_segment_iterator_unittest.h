...
private:
    typedef std::shared_ptr<PrimaryKeyPairSegmentIterator<uint64_t>> PrimaryKeyPairSegmentIteratorPtr;

private:
    template <typename Key>
    void CheckIterator(const PrimaryKeyPairSegmentIteratorPtr& iter, std::string resultStr);
...
///////////////////////////////////////////////////////////////////////////////
template <typename Key>
bool compFun(const std::pair<Key, docid_t>& left, const std::pair<Key, docid_t>& right)
{
...
template <typename Key>
void PrimaryKeyPairSegmentIteratorTest::CheckIterator(const PrimaryKeyPairSegmentIteratorPtr& iter,
