...
private:
    ...
    void CheckIterator(OnDiskOrderedPrimaryKeyIterator<Key>& iter, std::string docsStr);
...
template <typename Key>
void OnDiskOrderedPrimaryKeyIteratorTest::CheckIterator(OnDiskOrderedPrimaryKeyIterator<Key>& iter,
