...
DfAdaptiveBitmapTrigger::DfAdaptiveBitmapTrigger(int32_t threshold) : mThreshold(threshold) {}

DfAdaptiveBitmapTrigger::~DfAdaptiveBitmapTrigger() {}

bool DfAdaptiveBitmapTrigger::MatchAdaptiveBitmap(const PostingMergerPtr& postingMerger)
{
