 ...
 */
#ifndef __INDEXLIB_KKV_METRICS_RECORDER_H
#define __INDEXLIB_KKV_METRICS_RECORDER_H
...
DEFINE_SHARED_PTR(KKVMetricsRecorder);
}} // namespace indexlib::index

#endif //__INDEXLIB_KKV_METRICS_RECORDER_H
