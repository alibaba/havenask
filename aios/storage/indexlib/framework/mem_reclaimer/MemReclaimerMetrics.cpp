...
AUTIL_LOG_SETUP(indexlib.framework, MemReclaimerMetrics);

MemReclaimerMetrics::MemReclaimerMetrics(const std::shared_ptr<kmonitor::MetricsReporter>& metricsReporter)
