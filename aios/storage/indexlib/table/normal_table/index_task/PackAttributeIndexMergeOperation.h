...
class PackAttributeIndexMergeOperation : public IndexMergeOperation
{
public:
    PackAttributeIndexMergeOperation(const framework::IndexOperationDescription& opDesc);
    ~PackAttributeIndexMergeOperation() {}
