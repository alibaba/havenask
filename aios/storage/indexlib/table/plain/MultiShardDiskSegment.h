...
{
public:
    MultiShardDiskSegment(const std::shared_ptr<indexlibv2::config::TabletSchema>& schema,
    ...
    Status Reopen(const std::vector<std::shared_ptr<config::TabletSchema>>& schema) override
    {
        assert(false);
