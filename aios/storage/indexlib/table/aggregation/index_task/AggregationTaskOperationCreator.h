...
class AggregationTaskOperationCreator final : public framework::IIndexOperationCreator
{
public:
    explicit AggregationTaskOperationCreator(const std::shared_ptr<config::TabletSchema>& schema);
    ~AggregationTaskOperationCreator();
