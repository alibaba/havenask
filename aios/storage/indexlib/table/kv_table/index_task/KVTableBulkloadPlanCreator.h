...
class KVTableBulkloadPlanCreator : public SimpleIndexTaskPlanCreator
{
public:
    static const std::string TASK_TYPE;

    KVTableBulkloadPlanCreator(const std::string& taskName = "", const std::string& taskTraceId = "",
                               const std::map<std::string, std::string>& params = {});
    ~KVTableBulkloadPlanCreator() = default;
