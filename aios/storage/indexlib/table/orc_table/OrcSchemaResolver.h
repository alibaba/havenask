...
class OrcSchemaResolver : public config::SchemaResolver
{
public:
    OrcSchemaResolver() = default;
    ~OrcSchemaResolver() = default;
...
private:
    ...
    Status FillPkConfig(const indexlib::config::IndexPartitionSchema& legacySchema, config::UnresolvedSchema* schema);
    Status FillOrcConfig(const indexlib::config::IndexPartitionSchema& legacySchema, config::UnresolvedSchema* schema);
