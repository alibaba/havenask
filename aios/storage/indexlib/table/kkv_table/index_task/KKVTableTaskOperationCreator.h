...
class KKVTableTaskOperationCreator : public framework::IIndexOperationCreator
{
public:
    KKVTableTaskOperationCreator(const std::shared_ptr<config::ITabletSchema>& schema);
    ~KKVTableTaskOperationCreator();
