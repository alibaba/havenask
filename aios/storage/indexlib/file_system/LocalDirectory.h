...
class LocalDirectory : public DirectoryImpl
{
public:
    LocalDirectory(const std::string& path, const std::shared_ptr<IFileSystem>& fileSystem) noexcept;
    ~LocalDirectory() noexcept;
