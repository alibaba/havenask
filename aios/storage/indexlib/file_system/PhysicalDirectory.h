...
class PhysicalDirectory final : public DirectoryImpl
{
public:
    PhysicalDirectory(const std::string& path) noexcept;
    ~PhysicalDirectory() = default;
...
typedef std::shared_ptr<PhysicalDirectory> PhysicalDirectoryPtr;
