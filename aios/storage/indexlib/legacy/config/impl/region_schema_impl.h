...
public:
    ...
    void SetSummaryCompress(bool compress, const std::string& compressType = "",
                            index::summarygroupid_t summaryGroupId = index::DEFAULT_SUMMARYGROUPID);
    void SetAdaptiveOffset(bool adaptiveOffset, index::summarygroupid_t summaryGroupId = index::DEFAULT_SUMMARYGROUPID);
...
private:
    ...
    bool LoadSummaryGroup(const autil::legacy::Any& any, index::summarygroupid_t summaryGroupId);
