...
AUTIL_LOG_SETUP(indexlib.config, CustomizedConfigImpl);
...
bool CustomizedConfigImpl::GetParameters(const string& key, string& value) const
{
...
void CustomizedConfigImpl::SetId(const string& id) { mId = id; }

void CustomizedConfigImpl::SetPluginName(const string& pluginName) { mPluginName = pluginName; }
