...
private:
    ...
    static index::format_versionid_t GetFormatVersion(const autil::legacy::json::JsonMap& indexMap,
...
typedef std::shared_ptr<IndexConfigCreator> IndexConfigCreatorPtr;
