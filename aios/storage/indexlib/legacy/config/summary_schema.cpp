...
AUTIL_LOG_SETUP(indexlib.config, SummarySchema);
...
void SummarySchema::AddSummaryConfig(const std::shared_ptr<SummaryConfig>& summaryConfig,
...
index::summaryfieldid_t SummarySchema::GetSummaryFieldId(fieldid_t fieldId) const
{
...
index::summarygroupid_t SummarySchema::CreateSummaryGroup(const string& groupName)
{
    return mImpl->CreateSummaryGroup(groupName);
}
index::summarygroupid_t SummarySchema::FieldIdToSummaryGroupId(fieldid_t fieldId) const
{
    return mImpl->FieldIdToSummaryGroupId(fieldId);
}
index::summarygroupid_t SummarySchema::GetSummaryGroupId(const string& groupName) const
{
...
const SummaryGroupConfigPtr& SummarySchema::GetSummaryGroupConfig(index::summarygroupid_t groupId) const
{
    return mImpl->GetSummaryGroupConfig(groupId);
}
index::summarygroupid_t SummarySchema::GetSummaryGroupConfigCount() const
{
