...
AUTIL_LOG_SETUP(indexlib.config, ConditionFilterFunctionChecker);
...
{
    mBuildInFunc.insert(index::TIME_TO_NOW_FUNCTION);
...
{
    if (functionConfig.funcName == index::TIME_TO_NOW_FUNCTION) {
