...
#include "indexlib/index/common/numeric_compress/DecompressSse4.h"
...
template <typename T>
std::pair<Status, size_t> NewPForDeltaCompressor::Compress(uint32_t* dest, size_t destLen, const T* src, size_t srcLen,
                                                           bool enableBlockOpt)
{
...
template <typename T>
std::pair<Status, size_t> NewPForDeltaCompressor::CompressBlock(uint32_t* dest, size_t destLen, const T* src,
...
template <typename T>
inline std::pair<Status, size_t> NewPForDeltaCompressor::S9Encode(uint32_t* dest, size_t destLen, T* src, size_t srcLen)
{
