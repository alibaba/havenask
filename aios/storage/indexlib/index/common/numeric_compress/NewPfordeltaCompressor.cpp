...
AUTIL_LOG_SETUP(indexlib.index, NewPForDeltaCompressor);
...
std::pair<Status, size_t> NewPForDeltaCompressor::CompressInt32(uint32_t* dest, size_t destLen, const uint32_t* src,
                                                                size_t srcLen, bool enableBlockOpt) const
{
    return Compress<uint32_t>(dest, destLen, src, srcLen, enableBlockOpt);
}

std::pair<Status, size_t> NewPForDeltaCompressor::CompressInt16(uint32_t* dest, size_t destLen, const uint16_t* src,
                                                                size_t srcLen, bool enableBlockOpt) const
{
    return Compress<uint16_t>(dest, destLen, src, srcLen, enableBlockOpt);
}

std::pair<Status, size_t> NewPForDeltaCompressor::CompressInt8(uint32_t* dest, size_t destLen, const uint8_t* src,
                                                               size_t srcLen, bool enableBlockOpt) const
{
