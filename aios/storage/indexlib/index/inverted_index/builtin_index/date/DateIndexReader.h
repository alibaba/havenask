...
class DateIndexReader : public InvertedIndexReaderImpl
{
public:
    DateIndexReader(const std::shared_ptr<InvertedIndexMetrics>& metrics);
    ~DateIndexReader();
...
private:
    std::shared_ptr<indexlibv2::config::DateIndexConfig> _dateIndexConfig;
    std::shared_ptr<DateQueryParser> _dateQueryParser;
