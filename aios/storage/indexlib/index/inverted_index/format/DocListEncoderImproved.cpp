...
void DocListEncoderImproved::EndDocument(docid_t docId, docpayload_t docPayload)
{
...
void DocListEncoderImproved::AddDocument(docid_t docId, docpayload_t docPayload, tf_t tf, fieldmap_t fieldMap)
{
