...
public:
    ...
    void TestCaseForAddManyItems_1()
    {
    ...
    void TestCaseForAddManyItems_2()
    {
        uint32_t itemCount = ITEM_COUNT_PER_BLOCK * 256 + 1;
        TestAddItems<uint16_t>(itemCount);
        TestAddItems<uint32_t>(itemCount);
        TestAddItems<uint64_t>(itemCount, true);
    }

    void TestCaseForAddManyItems_3()
    {
        uint32_t itemCount = ITEM_COUNT_PER_BLOCK * 256 - 3;
        TestAddItems<uint16_t>(itemCount);
    ...
    {
        std::shared_ptr<file_system::Directory> rootDir = _rootDir;
...
private:
            ...
            std::string loadConfigStr = R"(
    {
        ...
        HashDictionaryWriter<KeyType> dictWriter(&_simplePool);
...
INDEXLIB_UNIT_TEST_CASE(HashDictionaryWriterTest, TestCaseForAddManyItems_1);
INDEXLIB_UNIT_TEST_CASE(HashDictionaryWriterTest, TestCaseForAddManyItems_2);
INDEXLIB_UNIT_TEST_CASE(HashDictionaryWriterTest, TestCaseForAddManyItems_3);
