...
class FixedLenValueReader final : public ValueReader
{
public:
    FixedLenValueReader(std::shared_ptr<indexlib::file_system::FileReader> file, uint32_t valueLen);
    ~FixedLenValueReader();
