...
FixedLenCuckooHashTableCreator<KeyType, ValueType, useCompactBucket>::CreateHashTable() noexcept
{
    static constexpr bool HasSpecialKey = ClosedHashTableTraits<KeyType, ValueType, useCompactBucket>::HasSpecialKey;
    using HashTableType = CuckooHashTable<KeyType, ValueType, HasSpecialKey, useCompactBucket>;
...
#define INDEXLIB_KV_HASHTABLE_INSTANTIATION_VALUETYPE(ValueType)                                                       \
    template class indexlibv2::index::FixedLenCuckooHashTableCreator<uint32_t, ValueType, true>;                       \
    template class indexlibv2::index::FixedLenCuckooHashTableCreator<uint32_t, ValueType, false>;                      \
    template class indexlibv2::index::FixedLenCuckooHashTableCreator<uint64_t, ValueType, true>;                       \
    template class indexlibv2::index::FixedLenCuckooHashTableCreator<uint64_t, ValueType, false>;
