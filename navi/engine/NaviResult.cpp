...
void NaviResult::serializeToString(std::string &data, autil::mem_pool::Pool *pool) const {
...
void NaviResult::deserializeFromString(const std::string &data, autil::mem_pool::Pool *pool) {
