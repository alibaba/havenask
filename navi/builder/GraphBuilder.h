...
public:
    ...
    GraphBuilder &testerMode(bool testerMode);
...
private:
    ...
    SubGraphBuildInfo *getGraphBuildInfo(GraphId graphId);
    SubGraphDef *getSubGraphDef(GraphId graph) const;
    N nodeInner(GraphId graphId, const std::string &name, NodeType nodeType);
