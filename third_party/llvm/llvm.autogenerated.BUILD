...
cc_library(
    ...
    # llvm runtime_dyld crashed with -fsplit-stack
    # clang11 may not support -fno-split-stack
    copts = llvm_copts + select({
        ":split_stack": ["-fno-split-stack"],
        "//conditions:default":[],
    }),
    deps = [
        ":config",
